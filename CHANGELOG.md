...
* chore(github): create issue templates ([`0f57662`](https://github.com/cosmos1255/python-semantic-release/commit/0f57662ce7f6ce540b80aa7ad857bcc24edbc897))
...
* chore: Re-add git user config to travis config ([`2c2809e`](https://github.com/cosmos1255/python-semantic-release/commit/2c2809ea360977c1e4010c84ac2d43ef94dc6154))
...
* ci: Configure trusted publishing in pypi ([`8e3c00b`](https://github.com/cosmos1255/python-semantic-release/commit/8e3c00b238859559d82ff692bcee15f70bf4f6ad))
...
* ci: Add python 3.9 to test runs ([`2a99b65`](https://github.com/cosmos1255/python-semantic-release/commit/2a99b65f10c8e7230a80885d2ebe6cacf6541450))
...
* docs: add note on default envvar behaviour (#780) ([`0b07cae`](https://github.com/cosmos1255/python-semantic-release/commit/0b07cae71915c5c82d7784898b44359249542a64))
...
Related to #327. ([`20d79a5`](https://github.com/cosmos1255/python-semantic-release/commit/20d79a51bffa26d40607c1b77d10912992279112))
...
* docs: add conda-forge badge ([`e9536bb`](https://github.com/cosmos1255/python-semantic-release/commit/e9536bbe119c9e3b90c61130c02468e0e1f14141))
...
* docs(readme): fix minor typo ([`c22f69f`](https://github.com/cosmos1255/python-semantic-release/commit/c22f69f62a215ff65e1ab6dcaa8e7e9662692e64))
...
* docs: Add retry option to cli docs ([`021da50`](https://github.com/cosmos1255/python-semantic-release/commit/021da5001934f3199c98d7cf29f62a3ad8c2e56a))
...
Co-authored-by: Mario Jäckle &lt;m.jaeckle@careerpartner.eu&gt; ([`7064265`](https://github.com/cosmos1255/python-semantic-release/commit/7064265627a2aba09caa2873d823b594e0e23e77))
...
* feat: Add support for non-prefixed tags (#366) ([`0fee4dd`](https://github.com/cosmos1255/python-semantic-release/commit/0fee4ddb5baaddf85ed6b76e76a04474a5f97d0a))
...
* feat(build): allow falsy values for build_command to disable build step ([`c07a440`](https://github.com/cosmos1255/python-semantic-release/commit/c07a440f2dfc45a2ad8f7c454aaac180c4651f70))
...
Add a config option to set the commands passed to setup.py when building distributions. This allows for things like adding custom commands to the build process. ([`22146ea`](https://github.com/cosmos1255/python-semantic-release/commit/22146ea4b94466a90d60b94db4cc65f46da19197))
...
Fixes #119 ([`f0ac82f`](https://github.com/cosmos1255/python-semantic-release/commit/f0ac82fe59eb59a768a73a1bf2ea934b9d448c58))
...
* feat(pypi): Add option to disable pypi upload ([`f5cd079`](https://github.com/cosmos1255/python-semantic-release/commit/f5cd079edb219de5ad03a71448d578f5f477da9c))
...
Co-authored-by: github-actions &lt;action@github.com&gt; ([`8a515ca`](https://github.com/cosmos1255/python-semantic-release/commit/8a515caf1f993aa653e024beda2fdb9e629cc42a))
...
* docs: `password` should be `token`. ([`f1a54a6`](https://github.com/cosmos1255/python-semantic-release/commit/f1a54a6c9a05b225b6474d50cd610eca19ec0c34))

* fix(changelog): use version as semver tag by default (#653) ([`5984c77`](https://github.com/cosmos1255/python-semantic-release/commit/5984c7771edc37f0d7d57894adecc2591efc414d))

* fix: skip unparseable versions when calculating next version (#649) ([`88f25ea`](https://github.com/cosmos1255/python-semantic-release/commit/88f25eae62589cdf53dbc3dfcb167a3ae6cba2d3))

* fix: handle missing configuration (#644) ([`f15753c`](https://github.com/cosmos1255/python-semantic-release/commit/f15753ce652f36cc03b108c667a26ab74bcbf95d))

* fix: invalid version in Git history should not cause a release failure (#632) ([`254430b`](https://github.com/cosmos1255/python-semantic-release/commit/254430b5cc5f032016b4c73168f0403c4d87541e))

* fix: relax invoke dependency constraint ([`18ea200`](https://github.com/cosmos1255/python-semantic-release/commit/18ea200633fd67e07f3d4121df5aa4c6dd29d154))

* fix: consider empty commits (#608) ([`6f2e890`](https://github.com/cosmos1255/python-semantic-release/commit/6f2e8909636595d3cb5e858f42c63820cda45974))
...
&gt; ERROR: failed to solve: process &#34;/bin/sh -c echo \&#34;deb http://deb.debian.org/debian bullseye-backports main\&#34; &gt;&gt; /etc/apt/sources.list;     apt-get update;    apt-get install -y git/bullseye-backports&#34; did not complete successfully: exit code: 100 ([`9e3eb97`](https://github.com/cosmos1255/python-semantic-release/commit/9e3eb979783bc39ca564c2967c6c77eecba682e6))

* fix: generate markdown linter compliant changelog headers &amp; lists (#597)

In #594, I missed that there are 2 places where the version header is formatted ([`cc87400`](https://github.com/cosmos1255/python-semantic-release/commit/cc87400d4a823350de7d02dc3172d2488c9517db))

* fix: open all files with explicit utf-8 encoding (#596) ([`cb71f35`](https://github.com/cosmos1255/python-semantic-release/commit/cb71f35c26c1655e675fa735fa880d39a2c8af9c))
...
for changelogs generated by this package ([`9d9d403`](https://github.com/cosmos1255/python-semantic-release/commit/9d9d40305c499c907335abe313e3ed122db0b154))
...
1.x version. ([`192da6e`](https://github.com/cosmos1255/python-semantic-release/commit/192da6e1352298b48630423d50191070a1c5ab24))

* fix: if prerelease, publish prerelease (#587)

Co-authored-by: Ondrej Winter &lt;ondrej.winter@gmail.com&gt; ([`927da9f`](https://github.com/cosmos1255/python-semantic-release/commit/927da9f8feb881e02bc08b33dc559bd8e7fc41ab))

* fix: update Gitmojis according to official node module (#582) ([`806fcfa`](https://github.com/cosmos1255/python-semantic-release/commit/806fcfa4cfdd3df4b380afd015a68dc90d54215a))

* fix: trim emojis from config (#583) ([`02902f7`](https://github.com/cosmos1255/python-semantic-release/commit/02902f73ee961565c2470c000f00947d9ef06cb1))

* fix: inconsistent versioning between print-version and publish (#524) ([`17d60e9`](https://github.com/cosmos1255/python-semantic-release/commit/17d60e9bf66f62e5845065486c9d5e450f74839a))

* fix(action): mark container fs as safe for git (#552)

See https://github.com/actions/runner-images/issues/6775#issuecomment-1409268124 and https://github.com/actions/runner-images/issues/6775#issuecomment-1410270956 ([`2a55f68`](https://github.com/cosmos1255/python-semantic-release/commit/2a55f68e2b3cb9ffa9204c00ddbf12706af5c070))
...
* Removes a couple of extra `strip()`s. ([`efb3410`](https://github.com/cosmos1255/python-semantic-release/commit/efb341036196c39b4694ca4bfa56c6b3e0827c6c))

* fix: bump Dockerfile to use Python 3.10 image (#536)

Fixes #533

Co-authored-by: Bernard Cooke &lt;bernard.cooke@iotics.com&gt; ([`8f2185d`](https://github.com/cosmos1255/python-semantic-release/commit/8f2185d570b3966b667ac591ae523812e9d2e00f))

* fix: fix mypy errors for publish ([`b40dd48`](https://github.com/cosmos1255/python-semantic-release/commit/b40dd484387c1b3f78df53ee2d35e281e8e799c8))

* fix: formatting in docs ([`2e8227a`](https://github.com/cosmos1255/python-semantic-release/commit/2e8227a8a933683250f8dace019df15fdb35a857))

* fix: update documentaton ([`5cbdad2`](https://github.com/cosmos1255/python-semantic-release/commit/5cbdad296034a792c9bf05e3700eac4f847eb469))

* fix(action): fix environment variable names ([`3c66218`](https://github.com/cosmos1255/python-semantic-release/commit/3c66218640044adf263fcf9b2714cfc4b99c2e90))

* fix: fix changelog generation in tag-mode (#171) ([`482a62e`](https://github.com/cosmos1255/python-semantic-release/commit/482a62ec374208b2d57675cb0b7f0ab9695849b9))

* fix: corrections for deprecation warnings (#505) ([`d47afb6`](https://github.com/cosmos1255/python-semantic-release/commit/d47afb6516238939e174f946977bf4880062a622))

* fix: account for trailing newlines in commit messages (#495)

Fixes #490 ([`111b151`](https://github.com/cosmos1255/python-semantic-release/commit/111b1518e8c8e2bd7535bd4c4b126548da384605))

* fix: use `commit_subject` when searching for release commits (#488)

Co-authored-by: Dzmitry Ryzhykau &lt;d.ryzhykau@onesoil.ai&gt; ([`3849ed9`](https://github.com/cosmos1255/python-semantic-release/commit/3849ed992c3cff9054b8690bcf59e49768f84f47))
...
Fixes #454 ([`e7a0e81`](https://github.com/cosmos1255/python-semantic-release/commit/e7a0e81c004ade73ed927ba4de8c3e3ccaf0047c))

* fix: Add repo=None when not in git repo

Fixes #422 ([`40be804`](https://github.com/cosmos1255/python-semantic-release/commit/40be804c09ab8a036fb135c9c38a63f206d2742c))

* fix: Update git email in action

Fixes #473 ([`0ece6f2`](https://github.com/cosmos1255/python-semantic-release/commit/0ece6f263ff02a17bb1e00e7ed21c490f72e3d00))

* fix: :bug: fix get_current_release_version for tag_only version_source ([`cad09be`](https://github.com/cosmos1255/python-semantic-release/commit/cad09be9ba067f1c882379c0f4b28115a287fc2b))

* fix: declare additional_options as action inputs (#481) ([`cb5d8c7`](https://github.com/cosmos1255/python-semantic-release/commit/cb5d8c7ce7d013fcfabd7696b5ffb846a8a6f853))

* fix: don&#39;t use commit_subject for tag pattern matching (#480) ([`ac3f11e`](https://github.com/cosmos1255/python-semantic-release/commit/ac3f11e689f4a290d20b68b9c5c214098eb61b5f))

* fix: allow empty additional options (#479) ([`c9b2514`](https://github.com/cosmos1255/python-semantic-release/commit/c9b2514d3e164b20e78b33f60989d78c2587e1df))

* fix: ignore dependency version bumps when parsing version from commit logs (#476) ([`51bcb78`](https://github.com/cosmos1255/python-semantic-release/commit/51bcb780a9f55fadfaf01612ff65c1f92642c2c1))
...
Co-authored-by: Dzmitry Ryzhykau &lt;d.ryzhykau@onesoil.ai&gt; ([`395bf4f`](https://github.com/cosmos1255/python-semantic-release/commit/395bf4f2de73663c070f37cced85162d41934213))

* fix(publish): get version bump for current release (#467)

Replicate the behavior of &#34;version&#34; command in version calculation.

Co-authored-by: Dzmitry Ryzhykau &lt;d.ryzhykau@onesoil.ai&gt; ([`dd26888`](https://github.com/cosmos1255/python-semantic-release/commit/dd26888a923b2f480303c19f1916647de48b02bf))

* fix: add packaging module requirement (#469) ([`b99c9fa`](https://github.com/cosmos1255/python-semantic-release/commit/b99c9fa88dc25e5ceacb131cd93d9079c4fb2c86))

* fix: add text for empty ValueError (#461) ([`733254a`](https://github.com/cosmos1255/python-semantic-release/commit/733254a99320d8c2f964d799ac4ec29737867faa))

* fix: Ensure that assets can be uploaded successfully on custom GitHub servers (#458)

Signed-off-by: Chris Butler &lt;cbutler@australiacloud.com.au&gt; ([`32b516d`](https://github.com/cosmos1255/python-semantic-release/commit/32b516d7aded4afcafe4aa56d6a5a329b3fc371d))

* fix: ensure should_bump checks against release version if not prerelease (#457)

Co-authored-by: Sebastian Seith &lt;sebastian@vermill.io&gt; ([`da0606f`](https://github.com/cosmos1255/python-semantic-release/commit/da0606f0d67ada5f097c704b9423ead3b5aca6b2))

* fix: Capture correct release version when patch has more than one digit (#448) ([`426cdc7`](https://github.com/cosmos1255/python-semantic-release/commit/426cdc7d7e0140da67f33b6853af71b2295aaac2))

* fix: fix and refactor prerelease (#435) ([`94c9494`](https://github.com/cosmos1255/python-semantic-release/commit/94c94942561f85f48433c95fd3467e03e0893ab4))

* fix: fix getting current version when `version_source=tag_only` (#437) ([`b247936`](https://github.com/cosmos1255/python-semantic-release/commit/b247936a81c0d859a34bf9f17ab8ca6a80488081))
...
was never passed. ([`aabab0b`](https://github.com/cosmos1255/python-semantic-release/commit/aabab0b7ce647d25e0c78ae6566f1132ece9fcb9))

* fix(gitea): use form-data from asset upload (#421) ([`e011944`](https://github.com/cosmos1255/python-semantic-release/commit/e011944987885f75b80fe16a363f4befb2519a91))

* fix(gitea): build status and asset upload (#420)

* fix(gitea): handle list build status response
* fix(gitea): use form-data for upload_asset ([`57db81f`](https://github.com/cosmos1255/python-semantic-release/commit/57db81f4c6b96da8259e3bad9137eaccbcd10f6e))

* fix: address PR feedback for `parser_angular.py`

- `angular_parser_default_level_bump` should have plain-english
  settings
- rename `TYPES` variable to `LONG_TYPE_NAMES` ([`f7bc458`](https://github.com/cosmos1255/python-semantic-release/commit/f7bc45841e6a5c762f99f936c292cee25fabcd02))

* fix: mypy errors in vcs_helpers ([`13ca0fe`](https://github.com/cosmos1255/python-semantic-release/commit/13ca0fe650125be2f5e953f6193fdc4d44d3c75a))

* fix: remove invalid repository exception ([`746b62d`](https://github.com/cosmos1255/python-semantic-release/commit/746b62d4e207a5d491eecd4ca96d096eb22e3bed))

* fix: skip removing the build folder if it doesn&#39;t exist

https://github.com/relekang/python-semantic-release/issues/391#issuecomment-950667599 ([`8e79fdc`](https://github.com/cosmos1255/python-semantic-release/commit/8e79fdc107ffd852a91dfb5473e7bd1dfaba4ee5))

* fix: don&#39;t use linux commands on windows (#393) ([`5bcccd2`](https://github.com/cosmos1255/python-semantic-release/commit/5bcccd21cc8be3289db260e645fec8dc6a592abd))

* fix: Fixed ImproperConfig import error (#377) ([`b011a95`](https://github.com/cosmos1255/python-semantic-release/commit/b011a9595df4240cb190bfb1ab5b6d170e430dfc))

* fix: add get_formatted_tag helper instead of hardcoded v-prefix in the git tags ([`1a354c8`](https://github.com/cosmos1255/python-semantic-release/commit/1a354c86abad77563ebce9a6944256461006f3c7))

* fix: correct rendering of gitlab issue references

resolves #358 ([`07429ec`](https://github.com/cosmos1255/python-semantic-release/commit/07429ec4a32d32069f25ec77b4bea963bd5d2a00))

* fix: print right info if token is not set (#360) (#361)

Co-authored-by: Laercio Barbosa &lt;laercio.barbosa@scania.com&gt; ([`a275a7a`](https://github.com/cosmos1255/python-semantic-release/commit/a275a7a17def85ff0b41d254e4ee42772cce1981))

* fix: use release-api for gitlab ([`1ef5cab`](https://github.com/cosmos1255/python-semantic-release/commit/1ef5caba2d8dd0f2647bc51ede0ef7152d8b7b8d))

* fix: tomlkit should stay at 0.7.0

See https://github.com/relekang/python-semantic-release/pull/339#discussion_r647629387 ([`769a5f3`](https://github.com/cosmos1255/python-semantic-release/commit/769a5f31115cdb1f43f19a23fe72b96a8c8ba0fc))

* fix: update click and tomlkit (#339) ([`947ea3b`](https://github.com/cosmos1255/python-semantic-release/commit/947ea3bc0750735941446cf4a87bae20e750ba12))

* fix: pin tomlkit to 0.7.0 ([`2cd0db4`](https://github.com/cosmos1255/python-semantic-release/commit/2cd0db4537bb9497b72eb496f6bab003070672ab))

* fix: Change log level of failed toml loading

Fixes #235 ([`24bb079`](https://github.com/cosmos1255/python-semantic-release/commit/24bb079cbeff12e7043dd35dd0b5ae03192383bb))

* fix: Add venv to path in github action ([`583c5a1`](https://github.com/cosmos1255/python-semantic-release/commit/583c5a13e40061fc544b82decfe27a6c34f6d265))

* fix: Use absolute path for venv in github action ([`d4823b3`](https://github.com/cosmos1255/python-semantic-release/commit/d4823b3b6b1fcd5c33b354f814643c9aaf85a06a))

* fix: Set correct path for venv in action script ([`aac02b5`](https://github.com/cosmos1255/python-semantic-release/commit/aac02b5a44a6959328d5879578aa3536bdf856c2))

* fix: Run semantic-release in virtualenv in the github action

Fixes #331 ([`b508ea9`](https://github.com/cosmos1255/python-semantic-release/commit/b508ea9f411c1cd4f722f929aab9f0efc0890448))

* fix: Add support for setting build_command to &#34;false&#34;

Fixes #328 ([`520cf1e`](https://github.com/cosmos1255/python-semantic-release/commit/520cf1eaa7816d0364407dbd17b5bc7c79806086))
...
Fixes #329 ([`abfacc4`](https://github.com/cosmos1255/python-semantic-release/commit/abfacc432300941d57488842e41c06d885637e6c))
...
* chore: remove unused imports ([`5f8ab99`](https://github.com/cosmos1255/python-semantic-release/commit/5f8ab99bf7254508f4b38fcddef2bdde8dd15a4c))

* fix: use multiline version_pattern match in replace (#315)

Fixes #306 ([`1a85af4`](https://github.com/cosmos1255/python-semantic-release/commit/1a85af434325ce52e11b49895e115f7a936e417e))

* fix(actions): fix github actions with new main location ([`6666672`](https://github.com/cosmos1255/python-semantic-release/commit/6666672d3d97ab7cdf47badfa3663f1a69c2dbdf))

* fix: avoid Unknown bump level 0 message

This issue occurs when some commits are available but are all to level 0. ([`8ab624c`](https://github.com/cosmos1255/python-semantic-release/commit/8ab624cf3508b57a9656a0a212bfee59379d6f8b))

* fix: add dot to --define option help ([`eb4107d`](https://github.com/cosmos1255/python-semantic-release/commit/eb4107d2efdf8c885c8ae35f48f1b908d1fced32))
...
Add test case asserting it&#39;s type str ([`d4cdc3d`](https://github.com/cosmos1255/python-semantic-release/commit/d4cdc3d3cd2d93f2a78f485e3ea107ac816c7d00))

* fix(history): require semver &gt;= 2.10

This resolves deprecation warnings, and updates this to a more 3.x
compatible syntax ([`5087e54`](https://github.com/cosmos1255/python-semantic-release/commit/5087e549399648cf2e23339a037b33ca8b62d954))

* fix(cli): skip remove_dist where not needed

Skip removing dist files when upload_pypi or upload_release are not set ([`04817d4`](https://github.com/cosmos1255/python-semantic-release/commit/04817d4ecfc693195e28c80455bfbb127485f36b))
...
This also refactor some other parts to use f-strings as much as possible. ([`2591a94`](https://github.com/cosmos1255/python-semantic-release/commit/2591a94115114c4a91a48f5b10b3954f6ac932a1))
...
In this case, application/octect-stream is now used as a fallback. ([`f3ece78`](https://github.com/cosmos1255/python-semantic-release/commit/f3ece78b2913e70f6b99907b192a1e92bbfd6b77))
...
This also add a test to make sure .netrc is used properly when no GH_TOKEN is defined. ([`3af32a7`](https://github.com/cosmos1255/python-semantic-release/commit/3af32a738f2f2841fd75ec961a8f49a0b1c387cf))
...
the end of a PR that is merged via rebase merge or merge commit. ([`93e48c9`](https://github.com/cosmos1255/python-semantic-release/commit/93e48c992cb8b763f430ecbb0b7f9c3ca00036e4))

* fix: add &#34;changelog_capitalize&#34; to flags (#279)

Fixes #278 (or so I hope). ([`37716df`](https://github.com/cosmos1255/python-semantic-release/commit/37716dfa78eb3f848f57a5100d01d93f5aafc0bf))

* fix: add required to inputs in action metadata (#264)

According to the documentation, `inputs.&lt;input_id&gt;.required` is a
required field. ([`e76b255`](https://github.com/cosmos1255/python-semantic-release/commit/e76b255cf7d3d156e3314fc28c54d63fa126e973))

* fix: Use range for toml dependency

Fixes #241 ([`45707e1`](https://github.com/cosmos1255/python-semantic-release/commit/45707e1b7dcab48103a33de9d7f9fdb5a34dae4a))

* fix: support multiline version_pattern matching by default ([`82f7849`](https://github.com/cosmos1255/python-semantic-release/commit/82f7849dcf29ba658e0cb3b5d21369af8bf3c16f))

* fix(changelog): send changelog to stdout

Fixes #250 ([`87e2bb8`](https://github.com/cosmos1255/python-semantic-release/commit/87e2bb881387ff3ac245ab9923347a5a616e197b))

* fix: commit all files with bumped versions (#249) ([`b3a1766`](https://github.com/cosmos1255/python-semantic-release/commit/b3a1766be7edb7d2eb76f2726d35ab8298688b3b))

* fix(changelog): swap sha and message in table changelog ([`6741370`](https://github.com/cosmos1255/python-semantic-release/commit/6741370ab09b1706ff6e19b9fbe57b4bddefc70d))

* fix: convert \r\n to \n in commit messages

Fixes #239 ([`34acbbc`](https://github.com/cosmos1255/python-semantic-release/commit/34acbbcd25320a9d18dcd1a4f43e1ce1837b2c9f))

* fix: use getboolean for commit_version_number

Fixes #186 ([`a60e0b4`](https://github.com/cosmos1255/python-semantic-release/commit/a60e0b4e3cadf310c3e0ad67ebeb4e69d0ee50cb))

* fix(hvcs): convert get_hvcs to use LoggedFunction

This was missed in 213530fb0c914e274b81d1dacf38ea7322b5b91f ([`3084249`](https://github.com/cosmos1255/python-semantic-release/commit/308424933fd3375ca3730d9eaf8abbad2435830b))
...
* chore: isort errors ([`0a6f8c3`](https://github.com/cosmos1255/python-semantic-release/commit/0a6f8c3842b05f5f424dad5ce1fa5e3823c7e688))

* fix(history): leave case of other characters unchanged

Previously, use of str.capitalize() would capitalize the first letter as expected, but all subsequent letters became lowercase. Now, the other letters remain unchanged. ([`96ba94c`](https://github.com/cosmos1255/python-semantic-release/commit/96ba94c4b4593997343ec61ecb6c823c1494d0e2))
...
will get the version they specify. ([`123984d`](https://github.com/cosmos1255/python-semantic-release/commit/123984d735181c622f3d99088a1ad91321192a11))

* fix: Rename default of build_command config ([`d5db22f`](https://github.com/cosmos1255/python-semantic-release/commit/d5db22f9f7acd05d20fd60a8b4b5a35d4bbfabb8))

* fix(pypi): change bdist_wheels to bdist_wheel

Change the incorrect command bdist_wheels to bdist_wheel. ([`c4db509`](https://github.com/cosmos1255/python-semantic-release/commit/c4db50926c03f3d551c8331932c567c7bdaf4f3d))
...
Fixes #181 ([`0fddbe2`](https://github.com/cosmos1255/python-semantic-release/commit/0fddbe2fb70d24c09ceddb789a159162a45942dc))

* fix: support repository owner names containing dots

Fixes #179 ([`a6c4da4`](https://github.com/cosmos1255/python-semantic-release/commit/a6c4da4c0e6bd8a37f64544f7813fa027f5054ed))

* fix(github): use application/octet-stream for .whl files

application/octet-stream is more generic, but it is better than using a non-official MIME type. ([`90a7e47`](https://github.com/cosmos1255/python-semantic-release/commit/90a7e476a04d26babc88002e9035cad2ed485b07))

* fix: Only overwrite with patch if bump is None

Fixes #159 ([`1daa4e2`](https://github.com/cosmos1255/python-semantic-release/commit/1daa4e23ec2dd40c6b490849276524264787e24e))

* fix: Add more debug statements in logs ([`bc931ec`](https://github.com/cosmos1255/python-semantic-release/commit/bc931ec46795fde4c1ccee004eec83bf73d5de7a))
...
Fixes relekang/python-semantic-release#167 ([`be9972a`](https://github.com/cosmos1255/python-semantic-release/commit/be9972a7b1fb183f738fb31bd370adb30281e4d5))

* fix: Remove erroneous submodule ([`762bfda`](https://github.com/cosmos1255/python-semantic-release/commit/762bfda728c266b8cd14671d8da9298fc99c63fb))
...
Closes #73 ([`4fcc781`](https://github.com/cosmos1255/python-semantic-release/commit/4fcc781d1a3f9235db552f0f4431c9f5e638d298))

* fix: Add quotes around twine arguments

Fixes #163 ([`46a83a9`](https://github.com/cosmos1255/python-semantic-release/commit/46a83a94b17c09d8f686c3ae7b199d7fd0e0e5e5))

* fix(github): add check for GITHUB_ACTOR for git push (#162) ([`c41e9bb`](https://github.com/cosmos1255/python-semantic-release/commit/c41e9bb986d01b92d58419cbdc88489d630a11f1))
...
Fixes #51 ([`252bffd`](https://github.com/cosmos1255/python-semantic-release/commit/252bffd3be7b6dfcfdb384d24cb1cd83d990fc9a))
...
* The string template has no variables, so remove the call to .format() ([`f07c7f6`](https://github.com/cosmos1255/python-semantic-release/commit/f07c7f653be1c018e443f071d9a196d9293e9521))
...
Fixes #151 ([`2778e31`](https://github.com/cosmos1255/python-semantic-release/commit/2778e316a0c0aa931b1012cb3862d04659c05e73))

* fix: support repo urls without git terminator ([`700e9f1`](https://github.com/cosmos1255/python-semantic-release/commit/700e9f18dafde1833f482272a72bb80b54d56bb3))

* fix: update list of commit types to include build, ci and perf

Also added perf to the types that trigger a patch update

Fixes #145 ([`41ea12f`](https://github.com/cosmos1255/python-semantic-release/commit/41ea12fa91f97c0046178806bce3be57c3bc2308))
...
Fixes #139
Fixes #140 ([`4b11875`](https://github.com/cosmos1255/python-semantic-release/commit/4b118754729094e330389712cf863e1c6cefee69))

* fix: Remove deletion of build folder

Fixes #115 ([`b45703d`](https://github.com/cosmos1255/python-semantic-release/commit/b45703dad38c29b28575060b21e5fb0f8482c6b1))

* fix: updated the tag tests ([`3303eef`](https://github.com/cosmos1255/python-semantic-release/commit/3303eefa49a0474bbd85df10ae186ccbf9090ec1))

* fix: kept setting new version for tag source ([`0e24a56`](https://github.com/cosmos1255/python-semantic-release/commit/0e24a5633f8f94b48da97b011634d4f9d84f7b4b))

* fix: Add commit hash when generating breaking changes

Fixes #120 ([`0c74faf`](https://github.com/cosmos1255/python-semantic-release/commit/0c74fafdfa81cf2e13db8f4dcf0a6f7347552504))

* fix: Upgrade click to 7.0 ([`2c5dd80`](https://github.com/cosmos1255/python-semantic-release/commit/2c5dd809b84c2157a5e6cdcc773c43ec864f0328))

* fix: Make sure the history only breaks loop for version commit

Fixes #135 ([`5dc6cfc`](https://github.com/cosmos1255/python-semantic-release/commit/5dc6cfc634254f09997bb3cb0f17abd296e2c01f))

* fix: correct isort build fail

build fail:  https://circleci.com/gh/relekang/python-semantic-release/379 ([`0037210`](https://github.com/cosmos1255/python-semantic-release/commit/00372100b527ff9308d9e43fe5c65cdf179dc4dc))

* fix(vcs): allow cli to be run from subdirectory ([`fb7bb14`](https://github.com/cosmos1255/python-semantic-release/commit/fb7bb14300e483626464795b8ff4f033a194cf6f))
...
I am using python-semantic-release with a Julia project and this change will allow for consistent formatting in my Project.toml file where the version is maintained ([`bf63156`](https://github.com/cosmos1255/python-semantic-release/commit/bf63156f60340614fae94c255fb2f097cf317b2b))

* fix: initialize git Repo from current folder

This allows to run the program also from inner repository folders ([`c7415e6`](https://github.com/cosmos1255/python-semantic-release/commit/c7415e634c0affbe6396e0aa2bafe7c1b3368914))

* fix: Use same changelog code for command as post

See #27 for background. ([`248f622`](https://github.com/cosmos1255/python-semantic-release/commit/248f62283c59182868c43ff105a66d85c923a894))

* fix: Use correct syntax to exclude tests in package

This implements #92 without deleting __init__.py files. ([`3e41e91`](https://github.com/cosmos1255/python-semantic-release/commit/3e41e91c318663085cd28c8165ece21d7e383475))

* fix: Filter out pypi secrets from exceptions

Fixes #41 ([`5918371`](https://github.com/cosmos1255/python-semantic-release/commit/5918371c1e82b06606087c9945d8eaf2604a0578))

* fix: Clean out dist and build before building

This should fix the problem with uploading old versions.

Fixes #86 ([`b628e46`](https://github.com/cosmos1255/python-semantic-release/commit/b628e466f86bc27cbe45ec27a02d4774a0efd3bb))

* fix: Add better error message when pypi credentials are empty

Fixes #96 ([`c4e5dcb`](https://github.com/cosmos1255/python-semantic-release/commit/c4e5dcbeda0ce8f87d25faefb4d9ae3581029a8f))

* fix: Unfreeze dependencies

This uses ~= for most dependencies instead of pinning them.

Fixes #100 ([`847833b`](https://github.com/cosmos1255/python-semantic-release/commit/847833bf48352a4935f906d0c3f75e1db596ca1c))

* fix(parser_angular): Fix non-match when special chars in scope ([`8a33123`](https://github.com/cosmos1255/python-semantic-release/commit/8a331232621b26767e4268079f9295bf695047ab))

* fix: Add credentials check ([`0694604`](https://github.com/cosmos1255/python-semantic-release/commit/0694604f3b3d2159a4037620605ded09236cdef5))

* fix: Add check of credentials ([`7d945d4`](https://github.com/cosmos1255/python-semantic-release/commit/7d945d44b36b3e8c0b7771570cb2305e9e09d0b2))

* fix: Add dists to twine call ([`1cec2df`](https://github.com/cosmos1255/python-semantic-release/commit/1cec2df8bcb7f877c813d6470d454244630b050a))

* fix: Re-add skip-existing ([`366e9c1`](https://github.com/cosmos1255/python-semantic-release/commit/366e9c1d0b9ffcde755407a1de18e8295f6ad3a1))

* fix: Use twine through cli call ([`ab84beb`](https://github.com/cosmos1255/python-semantic-release/commit/ab84beb8f809e39ae35cd3ce5c15df698d8712fd))

* fix: Use new interface for twine ([`c04872d`](https://github.com/cosmos1255/python-semantic-release/commit/c04872d00a26e9bf0f48eeacb360b37ce0fba01e))

* fix: Remove repository argument in twine ([`e24543b`](https://github.com/cosmos1255/python-semantic-release/commit/e24543b96adb208897f4ce3eaab96b2f4df13106))

* fix: Update twine ([`c4ae7b8`](https://github.com/cosmos1255/python-semantic-release/commit/c4ae7b8ecc682855a8568b247690eaebe62d2d26))

* fix: Remove universal from setup config ([`18b2402`](https://github.com/cosmos1255/python-semantic-release/commit/18b24025e397aace03dd5bb9eed46cfdd13491bd))
...
* revert changes to vcs helpers ([`af3ad59`](https://github.com/cosmos1255/python-semantic-release/commit/af3ad59f018876e11cc3acdda0b149f8dd5606bd))

* fix: Upgrade twine ([`9722313`](https://github.com/cosmos1255/python-semantic-release/commit/9722313eb63c7e2c32c084ad31bed7ee1c48a928))

* fix: change Gitpython version number

Change the Gitpython version number to fix a bug described in #80. ([`23c9d4b`](https://github.com/cosmos1255/python-semantic-release/commit/23c9d4b6a1716e65605ed985881452898d5cf644))

* fix: Make repo non if it is not a git repository

Fixes #74 ([`1dc306b`](https://github.com/cosmos1255/python-semantic-release/commit/1dc306b9b1db2ac360211bdc61fd815302d0014c))

* fix: Add pytest cache to gitignore ([`b8efd5a`](https://github.com/cosmos1255/python-semantic-release/commit/b8efd5a6249c79c8378bffea3e245657e7094ec9))
...
issue #74 ([`251b190`](https://github.com/cosmos1255/python-semantic-release/commit/251b190a2fd5df68892346926d447cbc1b32475a))

* fix: update call to upload to work with twine 1.9.1 (#72) ([`8f47643`](https://github.com/cosmos1255/python-semantic-release/commit/8f47643c54996e06c358537115e7e17b77cb02ca))

* fix: Update Twine (#69)

The publishing API is under development and older versions of Twine have problems to deal with newer versions of the API. Namely the logic of register/upload has changed (it was simplified). ([`9f268c3`](https://github.com/cosmos1255/python-semantic-release/commit/9f268c373a932621771abbe9607b739b1e331409))

* fix: Make changelog problems not fail whole publish

Can be fixed with changelog command later. ([`b5a68cf`](https://github.com/cosmos1255/python-semantic-release/commit/b5a68cf6177dc0ed80eda722605db064f3fe2062))

* fix: can&#39;t get the proper last tag from commit history

repo.tags returns a list sorted by the name rather than date, fix it by sorting them before iteration ([`5a0e681`](https://github.com/cosmos1255/python-semantic-release/commit/5a0e681e256ec511cd6c6a8edfee9d905891da10))

* fix: Add search_parent_directories option to gitpython (#62) ([`8bf9ce1`](https://github.com/cosmos1255/python-semantic-release/commit/8bf9ce11137399906f18bc8b25698b6e03a65034))

* fix: Refactoring cli.py to improve --help and error messages ([`c79fc34`](https://github.com/cosmos1255/python-semantic-release/commit/c79fc3469fb99bf4c7f52434fa9c0891bca757f9))

* fix: Add git fetch to frigg after success ([`74a6cae`](https://github.com/cosmos1255/python-semantic-release/commit/74a6cae2b46c5150e63136fde0599d98b9486e36))
...
while because the tests was not ran by pytest. ([`9496f6a`](https://github.com/cosmos1255/python-semantic-release/commit/9496f6a502c79ec3acb4e222e190e76264db02cf))

* fix: move code around a bit to make flake8 happy ([`41463b4`](https://github.com/cosmos1255/python-semantic-release/commit/41463b49b5d44fd94c11ab6e0a81e199510fabec))

* fix: Add requests as dependency ([`4525a70`](https://github.com/cosmos1255/python-semantic-release/commit/4525a70d5520b44720d385b0307e46fae77a7463))

* fix: Remove &#34; from git push command ([`031318b`](https://github.com/cosmos1255/python-semantic-release/commit/031318b3268bc37e6847ec049b37425650cebec8))

* fix: Do git push and git push --tags instead of --follow-tags ([`8bc70a1`](https://github.com/cosmos1255/python-semantic-release/commit/8bc70a183fd72f595c72702382bc0b7c3abe99c8))

* fix: Change build badge ([`0dc068f`](https://github.com/cosmos1255/python-semantic-release/commit/0dc068fff2f8c6914f4abe6c4e5fb2752669159e))

* fix: Only list commits from the last version tag

Fixes #28 ([`191369e`](https://github.com/cosmos1255/python-semantic-release/commit/191369ebd68526e5b1afcf563f7d13e18c8ca8bf))

* fix: Add pandoc to travis settings ([`17d40a7`](https://github.com/cosmos1255/python-semantic-release/commit/17d40a73062ffa774542d0abc0f59fc16b68be37))

* fix: Downgrade twine to version 1.5.0 ([`66df378`](https://github.com/cosmos1255/python-semantic-release/commit/66df378330448a313aff7a7c27067adda018904f))

* fix: Add missing parameters to twine.upload ([`4bae22b`](https://github.com/cosmos1255/python-semantic-release/commit/4bae22bae9b9d9abf669b028ea3af4b3813a1df0))

* fix: Push to master by default ([`a0bb023`](https://github.com/cosmos1255/python-semantic-release/commit/a0bb023438a1503f9fdb690d976d71632f19a21f))

* fix: Better filtering of github token in push error ([`9b31da4`](https://github.com/cosmos1255/python-semantic-release/commit/9b31da4dc27edfb01f685e6036ddbd4c715c9f60))

* fix: Make sure the github token is not in the output ([`55356b7`](https://github.com/cosmos1255/python-semantic-release/commit/55356b718f74d94dd92e6c2db8a15423a6824eb5))

* fix: Add requirements to manifest ([`ed25ecb`](https://github.com/cosmos1255/python-semantic-release/commit/ed25ecbaeec0e20ad3040452a5547bb7d6faf6ad))
...
clients will then download the latest sdist package available. ([`a1a35f4`](https://github.com/cosmos1255/python-semantic-release/commit/a1a35f43175187091f028474db2ebef5bfc77bc0))

* fix(deps): Use one file for requirements ([`4868543`](https://github.com/cosmos1255/python-semantic-release/commit/486854393b24803bb2356324e045ccab17510d46))

* fix(errors): Add exposing of errors in package ([`3662d76`](https://github.com/cosmos1255/python-semantic-release/commit/3662d7663291859dd58a91b4b4ccde4f0edc99b2))

* fix(version): Parse file instead for version

This makes it possible to use the version command without a setup.py
file. ([`005dba0`](https://github.com/cosmos1255/python-semantic-release/commit/005dba0094eeb4098315ef383a746e139ffb504d))

* fix(github): Fix property calls

Properties can only be used from instances. ([`7ecdeb2`](https://github.com/cosmos1255/python-semantic-release/commit/7ecdeb22de96b6b55c5404ebf54a751911c4d8cd))

* fix(hvcs): Make Github.token an property ([`37d5e31`](https://github.com/cosmos1255/python-semantic-release/commit/37d5e3110397596a036def5f1dccf0860964332c))

* fix(cli): Fix call to generate_changelog in publish ([`5f8bce4`](https://github.com/cosmos1255/python-semantic-release/commit/5f8bce4cbb5e1729e674efd6c651e2531aea2a16))

* fix(history): Fix issue in get_previous_version ([`f961786`](https://github.com/cosmos1255/python-semantic-release/commit/f961786aa3eaa3a620f47cc09243340fd329b9c2))

* fix(cli): Fix check of token in changelog command ([`cc6e6ab`](https://github.com/cosmos1255/python-semantic-release/commit/cc6e6abe1e91d3aa24e8d73e704829669bea5fd7))

* fix(github): Fix the github releases integration ([`f0c3c1d`](https://github.com/cosmos1255/python-semantic-release/commit/f0c3c1db97752b71f2153ae9f623501b0b8e2c98))

* fix(history): Fix changelog generation

This enables regeneration of a given versions changelog. ([`f010272`](https://github.com/cosmos1255/python-semantic-release/commit/f01027203a8ca69d21b4aff689e60e8c8d6f9af5))

* fix(cli): Change output indentation on changelog ([`2ca41d3`](https://github.com/cosmos1255/python-semantic-release/commit/2ca41d3bd1b8b9d9fe7e162772560e3defe2a41e))

* fix(history): Support unexpected types in changelog generator ([`13deacf`](https://github.com/cosmos1255/python-semantic-release/commit/13deacf5d33ed500e4e94ea702a2a16be2aa7c48))

* fix(history): Fix regex in angular parser

This fixes a problem where multiline commit messages where not correctly
parsed. ([`974ccda`](https://github.com/cosmos1255/python-semantic-release/commit/974ccdad392d768af5e187dabc184be9ac3e133d))

* fix(history): Fix level id&#39;s in angular parser ([`2918d75`](https://github.com/cosmos1255/python-semantic-release/commit/2918d759bf462082280ede971a5222fe01634ed8))

### Performance

* perf(algorithm): refactor bfs search to use queue rather than recursion ([`8b742d3`](https://github.com/cosmos1255/python-semantic-release/commit/8b742d3db6652981a7b5f773a74b0534edc1fc15))

### Refactor

* refactor: add lint workaround ([`55d6e03`](https://github.com/cosmos1255/python-semantic-release/commit/55d6e0349303e7b1a6a598a8f4eb54d708d1b27d))

* refactor: Fix type errors related to loading of repo ([`e09cc3c`](https://github.com/cosmos1255/python-semantic-release/commit/e09cc3c5fbb38caceb68b20198a98fea97599826))

* refactor: update VersionDeclaration to pathlib ([`e9d2916`](https://github.com/cosmos1255/python-semantic-release/commit/e9d2916094dd6a537adc6c643d759c3f49100941))

* refactor: use raise_for_status and enhance error reporting for github uploads ([`69aef9f`](https://github.com/cosmos1255/python-semantic-release/commit/69aef9f8ea11547cceb326068f7d3ab0bfa4afa7))

* refactor(history): move changelog_scope default (#284)

* Move the default for changelog_scope from inline to defaults.cfg.
* Add missing header in docs. ([`b7e1376`](https://github.com/cosmos1255/python-semantic-release/commit/b7e1376ee1688e5e6dcc069ce623f49e3a389052))

* refactor(history): combine = and : into one regex

Use a [=:] group instead of running two separate searches. ([`bbaf6b9`](https://github.com/cosmos1255/python-semantic-release/commit/bbaf6b926532314c41c733be24847a6ab5686a74))

* refactor(debug): improve debug output ([`213530f`](https://github.com/cosmos1255/python-semantic-release/commit/213530fb0c914e274b81d1dacf38ea7322b5b91f))

* refactor(vcs): add functools.wraps to check_repo ([`4d97187`](https://github.com/cosmos1255/python-semantic-release/commit/4d971873669d7ed5427108b180cbd5530375d8f3))

* refactor(history): use a named tuple for parsed commits

This improves readability as we can use attributes such as &#39;bump&#39; and 
&#39;descriptions&#39; instead of confusing numeric indices. ([`bff40d5`](https://github.com/cosmos1255/python-semantic-release/commit/bff40d53174ffe27451d82132c31b112c7bee9fd))

* refactor(cli): improve readability of cli.py and some log messages ([`646dd81`](https://github.com/cosmos1255/python-semantic-release/commit/646dd81944bad27f5defe4a33b0ebeb5c9ed0c4e))

* refactor: make check_repo a decorator ([`3799d8b`](https://github.com/cosmos1255/python-semantic-release/commit/3799d8b595d0b36e59e5486c9b5f1070a47f3903))

* refactor(history): remove unnecessary newlines

Since simplifying the capitalization, the comment is no longer needed and so the statement can be compacted onto one line again. ([`ffc3f8b`](https://github.com/cosmos1255/python-semantic-release/commit/ffc3f8bada5f9a031ffe3af1e00c01b0edb05740))

* refactor(history): use capitalize method for readability

Co-Authored-By: Rolf Erik Lekang &lt;me@rolflekang.com&gt; ([`289349a`](https://github.com/cosmos1255/python-semantic-release/commit/289349a314f63069ff6f7e40a9d0f2bf0f6063cf))

* refactor: added debug to hvcshvcs 

 
module did not have any debug ([`0c6237b`](https://github.com/cosmos1255/python-semantic-release/commit/0c6237bc01ec39608fb768925091c755d9bb25bd))

* refactor: fix import sorting ([`01e4c5d`](https://github.com/cosmos1255/python-semantic-release/commit/01e4c5d743f2f237d2c85481118e467d4f5fde15))

* refactor: add debug output ([`06f3788`](https://github.com/cosmos1255/python-semantic-release/commit/06f378819fea7c007176f0950db33b3d485a246a))

* refactor: Fix typing errors ([`5c37d47`](https://github.com/cosmos1255/python-semantic-release/commit/5c37d477053f3bf25b858c80ef176dada8110e7e))

* refactor: simplify code with clearer logic

add version_source to default.cfg to remove all get_option calls
remove some duplicate codes ([`4f11a86`](https://github.com/cosmos1255/python-semantic-release/commit/4f11a86b3b4b0d7a58cee83898d7568acecb5f94))

* refactor: Use gitpython instead of invoke in vcs_helpers

Fixes #3 ([`0d9b9a7`](https://github.com/cosmos1255/python-semantic-release/commit/0d9b9a76f8292889dc7fbb802988073ffbe59a4e))

* refactor: Fix quantified code warnings ([`6d16953`](https://github.com/cosmos1255/python-semantic-release/commit/6d1695320e09320f43efca403992d7d1791ff2a7))

* refactor(parsers): Move the parsing of the parts after line one to helpers ([`cefc8c6`](https://github.com/cosmos1255/python-semantic-release/commit/cefc8c68ed1d454010a5d81e752ec7b0b1761ebb))

* refactor(test): Move exit code assertion in cli tests ([`345c299`](https://github.com/cosmos1255/python-semantic-release/commit/345c299cbf4c0e626eb482b2f577dc8c5fd9426a))

* refactor(history): Move evaluate_version_bump ([`c448d9b`](https://github.com/cosmos1255/python-semantic-release/commit/c448d9b056d48d607a8bf7d38b8cf8a8ba038ca6))

### Style

* style: beautify 1c25b8e6f1e43c15ca7d5a59dca0a13767f9bc33 ([`85b2a2f`](https://github.com/cosmos1255/python-semantic-release/commit/85b2a2f5cf4c49aa3e394dfe3574e24266f93bfc))

* style: ruff linter ([`f7f7c8a`](https://github.com/cosmos1255/python-semantic-release/commit/f7f7c8a8d499126a16238e7183cde54e3ea4cea0))

* style: beautify 710d96482edae38438c090e5e631f2d6b6e990f2 ([`d2314f8`](https://github.com/cosmos1255/python-semantic-release/commit/d2314f86946df8a6ef30ca7a5bd163c5989e46f7))

* style(fixtures): update styling of imports on git repo fixture ([`710d964`](https://github.com/cosmos1255/python-semantic-release/commit/710d96482edae38438c090e5e631f2d6b6e990f2))

* style: beautify 8e3f87ce801498fdbb0c1b2261b9768941c0a21c ([`16c057a`](https://github.com/cosmos1255/python-semantic-release/commit/16c057a8da471a696f6d6484f2cc821fd883f5ed))

* style(tests): update typing &amp; import issues ([`2597ea5`](https://github.com/cosmos1255/python-semantic-release/commit/2597ea584ab5084ef6ab398b9ec6186a6191ac1f))

* style: beautify 8b742d3db6652981a7b5f773a74b0534edc1fc15 ([`f95be0c`](https://github.com/cosmos1255/python-semantic-release/commit/f95be0c207e499e214b12c578825bfcee0f2bbf8))

* style: beautify 70193ba117c1a6d3690aed685fee8a734ba174e5 ([`c777bb2`](https://github.com/cosmos1255/python-semantic-release/commit/c777bb261e8e46497c5c4b3fd84303db71772142))

* style: beautify 229c6471efc2c1bee002c3b89f58caf391b89e78 ([`c7be6e2`](https://github.com/cosmos1255/python-semantic-release/commit/c7be6e2330c3527302915fcf3334923ab5252480))

* style: beautify 9c594fb6efac7e4df2b0bfbd749777d3126d03d7 ([`6ed24fe`](https://github.com/cosmos1255/python-semantic-release/commit/6ed24fe81ae2cf2a3823a1dff78552abbd9fd363))

* style: beautify 011b0729cba3045b4e7291fd970cb17aad7bae60 ([`06d5c61`](https://github.com/cosmos1255/python-semantic-release/commit/06d5c610642f5a515317b9030368f279086696fc))

* style: beautify d6c4ae0db458f8108c88d75ac4e07079bc747d32 ([`253c99e`](https://github.com/cosmos1255/python-semantic-release/commit/253c99e72c1f4ddefd806c87cae10d1b72ff461b))

* style: beautify 26528eb8794d00dfe985812269702fbc4c4ec788 ([`514f558`](https://github.com/cosmos1255/python-semantic-release/commit/514f5580fbec0143f88d3f637be260c769136377))

* style: beautify cf75f237360488ebb0088e5b8aae626e97d9cbdd ([`2de634d`](https://github.com/cosmos1255/python-semantic-release/commit/2de634d6e1fed29e8ce55a1c57fd23bf838badd9))

* style: beautify 5efda8acfed938d3188cd55678ace20ecac7f798 ([`98b10b3`](https://github.com/cosmos1255/python-semantic-release/commit/98b10b3f08af16ab5cb00096b288afefbee1b74f))

* style: beautify c48c3b370335931d63391d1a4f5802937deff178 ([`bb3b631`](https://github.com/cosmos1255/python-semantic-release/commit/bb3b63111d0e02bd53c2ed25d5ab0e5a3d532136))

* style: beautify 6b2fc8c156e122ee1b43fdb513b2dc3b8fd76724 ([`9bf69d7`](https://github.com/cosmos1255/python-semantic-release/commit/9bf69d7005eee75f20b356bda97fea2d250a91de))

* style: beautify de6b9ad921e697b5ea2bb2ea8f180893cecca920 ([`c94fb6f`](https://github.com/cosmos1255/python-semantic-release/commit/c94fb6f53bd8bdeaa4f40219886fa7c6e8755f29))

* style: convert formatter from black to ruff (#746) ([`deb4dba`](https://github.com/cosmos1255/python-semantic-release/commit/deb4dbaba3de5396e0eb2389e728d0b1fe702843))

* style: beautify f1a54a6c9a05b225b6474d50cd610eca19ec0c34 ([`0280e10`](https://github.com/cosmos1255/python-semantic-release/commit/0280e104fcf8af3ed1341461d1eb9c1e83b5e4be))

* style: beautify 5984c7771edc37f0d7d57894adecc2591efc414d ([`df91bad`](https://github.com/cosmos1255/python-semantic-release/commit/df91bad58ccaf71ad31a61b1af6e69933b634adb))

* style: beautify 9d9d40305c499c907335abe313e3ed122db0b154 ([`2881c5f`](https://github.com/cosmos1255/python-semantic-release/commit/2881c5f79fb1dc7b5c4a8e37447f47edb8e3ff63))

* style: beautify 927da9f8feb881e02bc08b33dc559bd8e7fc41ab ([`00192bc`](https://github.com/cosmos1255/python-semantic-release/commit/00192bc9b1581d40e960383b25c07ce325618151))

* style: beautify 806fcfa4cfdd3df4b380afd015a68dc90d54215a ([`3fb49fb`](https://github.com/cosmos1255/python-semantic-release/commit/3fb49fbb0e043d258ac07a3695ab01161085917f))

* style: beautify 2a55f68e2b3cb9ffa9204c00ddbf12706af5c070 ([`30ad440`](https://github.com/cosmos1255/python-semantic-release/commit/30ad44019904c30aba86fb0d48dc88ce5e9eba39))

* style: beautify 8e4aa0e30438291ade98604a18aeb372f0d0b52f ([`729c2a7`](https://github.com/cosmos1255/python-semantic-release/commit/729c2a741705523ee16c0be790f54f013c07adcf))

* style: beautify b40dd484387c1b3f78df53ee2d35e281e8e799c8 ([`2aab9bd`](https://github.com/cosmos1255/python-semantic-release/commit/2aab9bd4fba532dfa632d2008bd10b2fe1e3eb05))

* style: beautify 3849ed992c3cff9054b8690bcf59e49768f84f47 ([`c84b1b7`](https://github.com/cosmos1255/python-semantic-release/commit/c84b1b749fb5e6262652210f4275fe4fbbd2b3c3))

* style: beautify cad09be9ba067f1c882379c0f4b28115a287fc2b ([`76eb536`](https://github.com/cosmos1255/python-semantic-release/commit/76eb536299195b2ce0d0411e9bc5c662526abd33))

* style: beautify 51bcb780a9f55fadfaf01612ff65c1f92642c2c1 ([`b47a323`](https://github.com/cosmos1255/python-semantic-release/commit/b47a3230c0778a67096dd9ba2ded5729247733d0))

* style: beautify dd26888a923b2f480303c19f1916647de48b02bf ([`9cb0b45`](https://github.com/cosmos1255/python-semantic-release/commit/9cb0b459702a98ee5d42aa66a141a965413ef7a1))

* style: beautify 733254a99320d8c2f964d799ac4ec29737867faa ([`55c9f4d`](https://github.com/cosmos1255/python-semantic-release/commit/55c9f4d44853b003d0822cc80cdf7f352d80f869))

* style: beautify 32b516d7aded4afcafe4aa56d6a5a329b3fc371d ([`fc5a703`](https://github.com/cosmos1255/python-semantic-release/commit/fc5a703ede88539ebc0624b59f9490976f5f96cf))

* style: beautify c8087fea6ce9f638e3fc7ea21e8cae62e43016f8 ([`772573f`](https://github.com/cosmos1255/python-semantic-release/commit/772573f6636f0a93c617cff29297e98edcb240df))

* style: beautify da0606f0d67ada5f097c704b9423ead3b5aca6b2 ([`5d363fa`](https://github.com/cosmos1255/python-semantic-release/commit/5d363fadc05a9cc074ce1cf2a777a879b4a82bc8))

* style: beautify 426cdc7d7e0140da67f33b6853af71b2295aaac2 ([`1c5184d`](https://github.com/cosmos1255/python-semantic-release/commit/1c5184db55efc9c1b4b2c59e6e7a7564396fb02a))

* style: beautify 2a25668b29e89ce656bc710c260e0bc5233d2997 ([`3575317`](https://github.com/cosmos1255/python-semantic-release/commit/357531782705de13901ec668b9ed489fad4a9e02))

* style: beautify aabab0b7ce647d25e0c78ae6566f1132ece9fcb9 ([`e17f83a`](https://github.com/cosmos1255/python-semantic-release/commit/e17f83a3b6657489f31d71dd916c682da5ff8aa9))

* style: beautify 7064265627a2aba09caa2873d823b594e0e23e77 ([`fab060a`](https://github.com/cosmos1255/python-semantic-release/commit/fab060ac0028fde527317418f6e88ccd152c6333))

* style: beautify 57db81f4c6b96da8259e3bad9137eaccbcd10f6e ([`9fbb28f`](https://github.com/cosmos1255/python-semantic-release/commit/9fbb28f932400d4c55cef2e03fe016345b6562bb))

* style: beautify aba6f5e1583c10a001b4ba1623b5806f6d506d69 ([`a4a8743`](https://github.com/cosmos1255/python-semantic-release/commit/a4a87432f5124098af1c889109746edc416f746a))

* style: beautify b7e7936331b7939db09abab235c8866d800ddc1a ([`f1e3ecb`](https://github.com/cosmos1255/python-semantic-release/commit/f1e3ecb79122fd2571660661441bc1ab4295cc92))

* style: beautify b631ca0a79cb2d5499715d43688fc284cffb3044 ([`c59095e`](https://github.com/cosmos1255/python-semantic-release/commit/c59095ed5953af2efd418ac7aec772e880b3ece3))

* style: beautify 3e34f957ff5a3ec6e6f984cc4a79a38ce4391ea9 ([`1ad5183`](https://github.com/cosmos1255/python-semantic-release/commit/1ad518379df054a089a2b6903c33ad622fc19ce7))

* style: beautify 01eea03a2c4db790bfa881037cdd2d6e8c1511a3 ([`6cf85a7`](https://github.com/cosmos1255/python-semantic-release/commit/6cf85a7ddb9cd6957eb761159cf75dc4df5ed58e))

* style: beautify 02569161e57b96a36294626012c311ae0d55a707 ([`6afa90c`](https://github.com/cosmos1255/python-semantic-release/commit/6afa90c3c357830a7357d3cc73a1098be78b68d3))

* style: beautify d7406ef55287c5a4a70e79c63292f5416ab0f00d ([`2cf59cc`](https://github.com/cosmos1255/python-semantic-release/commit/2cf59ccc28920df686a1fdcfef1894892d07e02c))

* style: beautify 1a354c86abad77563ebce9a6944256461006f3c7 ([`a3fc6c8`](https://github.com/cosmos1255/python-semantic-release/commit/a3fc6c8974d471366696545bb17218d509fb75d3))

* style: beautify 60393d730f16300df02cd071c7a21c5f9b591930 ([`a0015c7`](https://github.com/cosmos1255/python-semantic-release/commit/a0015c73d4d2e6eb4d610f50db2c2be1863c0e39))

* style: beautify 20603e53116d4f05e822784ce731b42e8cbc5d8f ([`db49709`](https://github.com/cosmos1255/python-semantic-release/commit/db49709c6da5cb7834fdfbe1909ba80ae070fefc))

* style: beautify b5ad0d7186bbde254e90450b3812c573c0d56f1e ([`b8fb692`](https://github.com/cosmos1255/python-semantic-release/commit/b8fb692793ba6868ae11ef25f64750d3c87ffcf1))

* style: improve code formatting ([`6ebc3b1`](https://github.com/cosmos1255/python-semantic-release/commit/6ebc3b15bb46fdbbfdd7381188826bc5204730b8))

* style: improve code formatting ([`a0cc0aa`](https://github.com/cosmos1255/python-semantic-release/commit/a0cc0aa51308fa109ff84668f46345fd6352bb95))

* style: improve code formatting ([`0b128ae`](https://github.com/cosmos1255/python-semantic-release/commit/0b128ae3b2e01722e949be92755e4e944d16c7d1))

* style: improve code formatting ([`0c0c45d`](https://github.com/cosmos1255/python-semantic-release/commit/0c0c45deae4bbf237608b0107d91884a9c5d5dc3))

* style: improve code formatting ([`a13dfde`](https://github.com/cosmos1255/python-semantic-release/commit/a13dfdefbbdc7b4031de39637220d6dc9d96f517))

* style: improve code formatting ([`be87196`](https://github.com/cosmos1255/python-semantic-release/commit/be8719605e0a9fa9fda2335556742e09cfa06189))

* style: improve code formatting ([`1dd8484`](https://github.com/cosmos1255/python-semantic-release/commit/1dd84847a9eaf8d2467ae5b4ee82492ef563612f))

* style: improve code formatting ([`766bd2e`](https://github.com/cosmos1255/python-semantic-release/commit/766bd2e12cb8aca36d4deb937033334c77144fb2))

* style: improve code formatting ([`6eec4b4`](https://github.com/cosmos1255/python-semantic-release/commit/6eec4b42cbfc546ee035de07451584a2672be485))

* style: improve code formatting ([`8182668`](https://github.com/cosmos1255/python-semantic-release/commit/81826680a30b062ebd3e2a21b62d655b1ac6a962))

* style: improve code formatting ([`38cf32e`](https://github.com/cosmos1255/python-semantic-release/commit/38cf32e986fc45c42101098e194cff881c111ea5))

* style(settings): alphabetize boolean settings (#283)

A few settings were not in alphabetical order. ([`60a3535`](https://github.com/cosmos1255/python-semantic-release/commit/60a3535f21380de8c9eaec7fe4dea9eb3d04dee1))

* style: improve code formatting ([`eaf0064`](https://github.com/cosmos1255/python-semantic-release/commit/eaf00643363f7040a4078d282e5589b2973c2dec))

* style: improve code formatting ([`b9016cd`](https://github.com/cosmos1255/python-semantic-release/commit/b9016cd234e5dea140a9aa61a52f99cec7f3726f))

* style: improve code formatting ([`8b62e79`](https://github.com/cosmos1255/python-semantic-release/commit/8b62e797dbab33a4a716d70c3abec6f46e36473f))

* style: improve code formatting ([`71fdb9f`](https://github.com/cosmos1255/python-semantic-release/commit/71fdb9ff83e56b22367dd810b09e2eaec51c6155))

* style: improve code formatting ([`904ed7e`](https://github.com/cosmos1255/python-semantic-release/commit/904ed7eb60332b1984529b2a38afaee3f5facdd3))

* style: improve code formatting ([`f040bb9`](https://github.com/cosmos1255/python-semantic-release/commit/f040bb96b677589be30c866dc0a483195b6ec74b))

* style: improve code formatting ([`a43beb5`](https://github.com/cosmos1255/python-semantic-release/commit/a43beb56f1bf4645be47399ded14756fb48d95c6))

* style: improve code formatting ([`1dfca97`](https://github.com/cosmos1255/python-semantic-release/commit/1dfca97c3856e496e9e2cda429b8aa093799bd5b))

* style: improve code formatting ([`9684c0f`](https://github.com/cosmos1255/python-semantic-release/commit/9684c0f3a96af46182f4ffcee041768a24ad9b71))

* style: improve code formatting ([`52bbd72`](https://github.com/cosmos1255/python-semantic-release/commit/52bbd729bc6a688b422b4abada6826231573f7ce))

* style: improve code formatting ([`2a88ef6`](https://github.com/cosmos1255/python-semantic-release/commit/2a88ef62da022fc7deb1985d09825a4067c1824d))

* style: improve code formatting ([`49b3389`](https://github.com/cosmos1255/python-semantic-release/commit/49b3389a316d221923b4957d83d4e005e85102d3))

* style: improve code formatting ([`ae4f1d6`](https://github.com/cosmos1255/python-semantic-release/commit/ae4f1d69866c3830d691e9bd6b48627d70f705ae))

* style: improve code formatting ([`7a85403`](https://github.com/cosmos1255/python-semantic-release/commit/7a8540322f1308399653d10657e24a7b28943767))

* style: improve code formatting ([`a1d324c`](https://github.com/cosmos1255/python-semantic-release/commit/a1d324c4d1824fe521d9e21fbd43589d26d3406c))

* style: improve code formatting ([`0a4d8ba`](https://github.com/cosmos1255/python-semantic-release/commit/0a4d8ba209c8fad7f254278e8bb382505885741d))

* style: improve code formatting ([`149e426`](https://github.com/cosmos1255/python-semantic-release/commit/149e426c7bf70482e14e41c69f96236090df7ed5))

* style: improve code formatting ([`a8fdab5`](https://github.com/cosmos1255/python-semantic-release/commit/a8fdab5b9dbc3dbf092181f30edbdd626a8f668c))

* style: improve code formatting ([`d1efc22`](https://github.com/cosmos1255/python-semantic-release/commit/d1efc22605b06e8901e82d7ddb865ef69f143c54))

* style: fix styling from 2997908

These code style problems were introduced because tests didn&#39;t run on 
#211. ([`172391e`](https://github.com/cosmos1255/python-semantic-release/commit/172391ec5b5e490081b9b0ea58a94dfd5be33937))

* style: improve readability of history/__init__.py ([`c878cd3`](https://github.com/cosmos1255/python-semantic-release/commit/c878cd3eb84fe8776913d082270720d4209e6007))

* style: improve readability of parsers ([`f84f317`](https://github.com/cosmos1255/python-semantic-release/commit/f84f31754240212822227f6880ff110a8dd95214))

* style: improve readability of history/logs.py ([`2f22892`](https://github.com/cosmos1255/python-semantic-release/commit/2f228921d30e6664986e1ab5a5e840297f52e2f0))

* style: improve readability of vcs_helpers.py ([`e46a358`](https://github.com/cosmos1255/python-semantic-release/commit/e46a35833c816e570ceea9d67297a725b8ffc9ff))

* style: improve readability of settings.py ([`af4df82`](https://github.com/cosmos1255/python-semantic-release/commit/af4df82603d9aac70e47672f196a0a5e5160f817))

* style(vcs_helpers): Add r prefix to regular expression match string

This &#39;raw&#39; designator gets rid of flake8 complaints ([`29c25d3`](https://github.com/cosmos1255/python-semantic-release/commit/29c25d34f61ae4c2058ffc3ae4219ae6ad8b2775))

* style: Fix flake8 ([`c9686a2`](https://github.com/cosmos1255/python-semantic-release/commit/c9686a2edafbb23dbf0955f124d5d0b431bd4786))

* style: Fix flake8 ([`d9239ea`](https://github.com/cosmos1255/python-semantic-release/commit/d9239ea32ffbce37e7c3b852a46660ea6aed75b9))

* style: Fix flake8 ([`a40f56f`](https://github.com/cosmos1255/python-semantic-release/commit/a40f56f7774382a100f27aa824aef5a0ae796c9a))

* style: Fix isort warnings ([`5411c8d`](https://github.com/cosmos1255/python-semantic-release/commit/5411c8d8b31229941fd32b0ffee937f4d36ff367))

* style: flake8 check ([`20422b4`](https://github.com/cosmos1255/python-semantic-release/commit/20422b4f1192c52c6706a4a7ddbc895e3e9208c8))

* style(pep8): Fix pep8 and isort warnings ([`87695b1`](https://github.com/cosmos1255/python-semantic-release/commit/87695b1684ad55e26e1489ab9d835cf8a9854654))

### Test

* test: remove environment variable tests ([`5c3fe69`](https://github.com/cosmos1255/python-semantic-release/commit/5c3fe694de5db0fc6a157a6a7717fa8c4d26f6f6))

* test: add bitbucket to changelog unit test ([`c33f8ff`](https://github.com/cosmos1255/python-semantic-release/commit/c33f8ff37e007a944b5fb1884b9e05b33ccd2047))

* test(fixtures): refactor repos to use common fixtures to simplify workflow ([`9ad8296`](https://github.com/cosmos1255/python-semantic-release/commit/9ad829693589e0cfe0962159f41cc2efd886eacc))

* test(fixtures): add common repo build/setup fixture ([`8da2840`](https://github.com/cosmos1255/python-semantic-release/commit/8da284095173f7bcece768e0452d8d18378454d4))

* test(fixtures): apply new repo definition to repos ([`1e13e2c`](https://github.com/cosmos1255/python-semantic-release/commit/1e13e2cee25b2760058bdd58238a9f55d5999c5e))

* test(fixtures): define new repo definition type ([`e0e8792`](https://github.com/cosmos1255/python-semantic-release/commit/e0e8792d9dcd3b7d3f4a41ef0f8fe2c92a761f55))

* test(fixtures): add generic multi-commit executor from definition ([`e9605f3`](https://github.com/cosmos1255/python-semantic-release/commit/e9605f37b001ff478f08f781587448c16ba31687))

* test(fixtures): add commit &amp; changelog entry derivation function ([`29dbc7c`](https://github.com/cosmos1255/python-semantic-release/commit/29dbc7cf6f9a066d9f6bd785fbeb11e700a586ac))

* test(fixtures): add manual release commit creation fixture ([`93dc523`](https://github.com/cosmos1255/python-semantic-release/commit/93dc523776af303e0870f42618bb1590948fb826))

* test(fixtures): expand hvcs use fixtures to set remote.domain value ([`1303a5a`](https://github.com/cosmos1255/python-semantic-release/commit/1303a5a5fcaec326f2cbe625d847c7de821a853d))

* test(fixtures): use const to set example project domain ([`1a15761`](https://github.com/cosmos1255/python-semantic-release/commit/1a15761c32de93b03628be0032f6a57f196d6ee1))

* test(constants): set starting example project version to 0.0.0 ([`310af11`](https://github.com/cosmos1255/python-semantic-release/commit/310af1150129e9d6ef833dd9a18860119b15ee01))

* test(fixtures): remove unused fixtures &amp; types ([`8e3f87c`](https://github.com/cosmos1255/python-semantic-release/commit/8e3f87ce801498fdbb0c1b2261b9768941c0a21c))

* test(util): add util func for removing readonly .git/* files ([`180a053`](https://github.com/cosmos1255/python-semantic-release/commit/180a053a992c0ffa03e1d9800cc4bf743d6331b2))

* test(fixtures): rename repo main and feature branches fixture across tests ([`f006e2b`](https://github.com/cosmos1255/python-semantic-release/commit/f006e2b2e9e2025a3b07d14d79714420d59a63fe))

* test(fixtures): add caching to github flow development repos ([`693b143`](https://github.com/cosmos1255/python-semantic-release/commit/693b14352da4fa2c7fcd969c4b8c5230ec90055c))

* test(fixtures): add caching to git flow development repos ([`3db33f0`](https://github.com/cosmos1255/python-semantic-release/commit/3db33f0c6556701de54ecc07dde91b65fc5d60a5))

* test(fixtures): add caching to trunk development w/ tags repos ([`4e3b6b6`](https://github.com/cosmos1255/python-semantic-release/commit/4e3b6b6ef3f493ca613e25b5a5bdb5545fa12e9f))

* test(fixtures): refactor for session level fixture use ([`a42b032`](https://github.com/cosmos1255/python-semantic-release/commit/a42b032ff44bedee81d20765163758c8a2ca6153))

* test(utils): add a utility to temporary change directory ([`68e12f3`](https://github.com/cosmos1255/python-semantic-release/commit/68e12f369deced9df9e2c8d08dae7a4e4ece3fee))

* test(fixtures): modularize git repo file into sub-modules ([`18d0877`](https://github.com/cosmos1255/python-semantic-release/commit/18d0877f6a6db38ed127b1c07d191075dda46904))

* test(fixtures): deconflict colliding fixtures for file dependent fixture execution ([`1890cf2`](https://github.com/cosmos1255/python-semantic-release/commit/1890cf2e8989e5fea182894e663c3659edf6903a))

* test(fixtures): cache the base example git directory ([`0cd0f44`](https://github.com/cosmos1255/python-semantic-release/commit/0cd0f44019a5dacf01040b6917b35f2a918d00ca))

* test(fixtures): adapt cli conftest fixtures to read when file is known to exist ([`0193cde`](https://github.com/cosmos1255/python-semantic-release/commit/0193cde64cf7e07a7ecd5a0ea9513105f6207386))

* test(algorithm): add bfs unit test on fake git history ([`2c8a36e`](https://github.com/cosmos1255/python-semantic-release/commit/2c8a36ea5b1d1fb19cfe90a3b8a1bce5077c717c))

* test(util): add windows line-endings possibilities for commit parsing ([`c57b082`](https://github.com/cosmos1255/python-semantic-release/commit/c57b0825c632da166c6dbe5b976c9edb1aa5882b))

* test(fixtures): cache the base example project directory (#799) ([`229c647`](https://github.com/cosmos1255/python-semantic-release/commit/229c6471efc2c1bee002c3b89f58caf391b89e78))

* test(infrastructure): refactor test fixtures &amp; configuration for higher resiliency (#773) ([`d6c4ae0`](https://github.com/cosmos1255/python-semantic-release/commit/d6c4ae0db458f8108c88d75ac4e07079bc747d32))

* test(commandline-main): prevent git gpgsign config from failing tests (#760) ([`744ff25`](https://github.com/cosmos1255/python-semantic-release/commit/744ff256f10c895a97241dc085bc132d10c9f737))

* test: refactor to pytest (#459) ([`c8087fe`](https://github.com/cosmos1255/python-semantic-release/commit/c8087fea6ce9f638e3fc7ea21e8cae62e43016f8))

* test: fix test_repo_with_custom_* on Windows (#416)

Prevent test_repo_with_custom_* from failing when run on Windows due to different path seperator. ([`aba6f5e`](https://github.com/cosmos1255/python-semantic-release/commit/aba6f5e1583c10a001b4ba1623b5806f6d506d69))

* test: Fix tests of angular options ([`01eea03`](https://github.com/cosmos1255/python-semantic-release/commit/01eea03a2c4db790bfa881037cdd2d6e8c1511a3))

* test: added releases to gitlab mock ([`60393d7`](https://github.com/cosmos1255/python-semantic-release/commit/60393d730f16300df02cd071c7a21c5f9b591930))

* test: add a failing test to reproduce tomlkit bug

Ref #336
Ref #338 ([`2041f10`](https://github.com/cosmos1255/python-semantic-release/commit/2041f10c722b8f381593eefb8f3fd80ea126edde))

* test: Fix test for bad toml syntax ([`e52ee3c`](https://github.com/cosmos1255/python-semantic-release/commit/e52ee3c4c9b0254822bf80a9369b9cdb2e50ba57))

* test(build): add tests for should_build() and should_remove_dist() ([`527f02b`](https://github.com/cosmos1255/python-semantic-release/commit/527f02bded40c46bc61f0aad57b707762ef0fba5))

* test: capture logging output

Adapt the CLI tests so that pytest can capture the log output, and display it if there is a failure. This helps with debugging. ([`32cfd90`](https://github.com/cosmos1255/python-semantic-release/commit/32cfd903f6f5fe8f31eb0dc1d45464071e54423d))

* test: split history tests into multiple files ([`14e4ae2`](https://github.com/cosmos1255/python-semantic-release/commit/14e4ae2a527b29026f49ee1346cab708114e60c9))

* test: test against Python 3.6 ([`a88efb9`](https://github.com/cosmos1255/python-semantic-release/commit/a88efb9c581fe4c90577b578b4e86efea7944ecc))

* test: Run --help in docker image to make testing of image easier ([`b41e6b2`](https://github.com/cosmos1255/python-semantic-release/commit/b41e6b27d63321bba8a6bb717de734df300ee1cc))

* test: better test coverage

Adds some coverage mainly on cli and vcs_helpers ([`b7bf6fe`](https://github.com/cosmos1255/python-semantic-release/commit/b7bf6fe4ea0f1d11e56ec6e39a242253061dc5fc))

* test: Fix test name ([`aff4454`](https://github.com/cosmos1255/python-semantic-release/commit/aff4454aa329bcab54b969ed0c41ed429a9b5683))

* test: Add mocking of reading of repo owner

Fixes #108 ([`04cc6b5`](https://github.com/cosmos1255/python-semantic-release/commit/04cc6b5af969275b1096cbf45f9dc03a105d7034))

* test: Update test after adding cleaning of dist ([`202fba5`](https://github.com/cosmos1255/python-semantic-release/commit/202fba50c287d3df99b22a4f30a96a3d8d9c8141))

* test(angular): Fix pep8 violations ([`a504f26`](https://github.com/cosmos1255/python-semantic-release/commit/a504f262a05dc27b87e2c766f185b17cd8b39765))

* test: Fix tests ([`d3862e8`](https://github.com/cosmos1255/python-semantic-release/commit/d3862e890f27d11ba4978de3f79746873731001a))

* test: Fix broken tests and add a test after 3e312c0 ([`c3e0339`](https://github.com/cosmos1255/python-semantic-release/commit/c3e0339c5d3d7ca05fef6714a91f1f321220785b))

* test: Make the tests green again ([`874307b`](https://github.com/cosmos1255/python-semantic-release/commit/874307b5deb6c5a3fcb1212ab54dd81f49f8459e))

* test: correct tests for tag version ([`1230fe9`](https://github.com/cosmos1255/python-semantic-release/commit/1230fe9add99bce2323f40e955d880fbb3f60216))

* test: change repo owner for online CI ([`2107813`](https://github.com/cosmos1255/python-semantic-release/commit/210781354458a9a952044dfadaf0f3e839109e29))

* test: Add tests for circle ci checks ([`fa1223c`](https://github.com/cosmos1255/python-semantic-release/commit/fa1223c661d60033b7d7aba2a27151d6ee18a299))

* test: Mock to fix cli tests ([`24e5f7a`](https://github.com/cosmos1255/python-semantic-release/commit/24e5f7a85bea75101b60baeeb36d6915464830c1))

* test: Make sure all publish tests mocks checkout

If not the tests will checkout master ([`742b2e9`](https://github.com/cosmos1255/python-semantic-release/commit/742b2e9e082c15f22052d64dea66f2d997d3d69b))

* test: Restructure ci checks tests ([`f36eb2e`](https://github.com/cosmos1255/python-semantic-release/commit/f36eb2ede0d6c4cb09861e5497629929c0ce4749))

* test: Update test setup ([`ac1e686`](https://github.com/cosmos1255/python-semantic-release/commit/ac1e6862d8990bb35250478d38af170ccedc81eb))

* test(github): Fix broken tests ([`a140ecd`](https://github.com/cosmos1255/python-semantic-release/commit/a140ecdc81c8e639b8d9adbedc7ac850c17f09cc))

### Unknown

* Revert &#34;feat(action): use composite action for semantic release (#692)&#34;

This reverts commit 4648d87bac8fb7e6cc361b765b4391b30a8caef8. ([`f145257`](https://github.com/cosmos1255/python-semantic-release/commit/f1452578cc064edbe64d61ae3baab4bc9bd4b666))

* Merge branch &#39;pr-364&#39; ([`0256916`](https://github.com/cosmos1255/python-semantic-release/commit/02569161e57b96a36294626012c311ae0d55a707))

* Merge pull request #395 from fleXible-public/feature/repository ([`d7406ef`](https://github.com/cosmos1255/python-semantic-release/commit/d7406ef55287c5a4a70e79c63292f5416ab0f00d))
...
#	tests/test_cli.py
#	tests/test_pypi.py
#	tests/test_settings.py ([`55bdbb9`](https://github.com/cosmos1255/python-semantic-release/commit/55bdbb9964311a00bf117325f8e84326c1b74c20))

* Merge branch &#39;master&#39; into feature/repository ([`b85fec5`](https://github.com/cosmos1255/python-semantic-release/commit/b85fec5c28191beb53b6a3552e5b88dbcc97db5f))

* doc: updated doc with new ParsedCommit object instead of nested Tuple ([`ac565dc`](https://github.com/cosmos1255/python-semantic-release/commit/ac565dc824ea575e8899b932db148ac28e27fce2))

* Fix minor sematic typo ([`76123f4`](https://github.com/cosmos1255/python-semantic-release/commit/76123f410180599a19e7c48da413880185bbea20))

* Merge pr #89

This was merged locally to fix conflicts. ([`0dad451`](https://github.com/cosmos1255/python-semantic-release/commit/0dad451617cc752ad3830c9442cf0b0e0993a454))

* Typo, link broken

Change `.. _angular commit guidelins:` to `.. _angular commit guidelines:` ([`721a6dd`](https://github.com/cosmos1255/python-semantic-release/commit/721a6dd895aa5f0072fc76fe0325f23e565492c4))

* 3.11.2 ([`762fbcf`](https://github.com/cosmos1255/python-semantic-release/commit/762fbcfb72f3ed269eaa1bbb8b0de433166a0a47))

* 3.11.1 ([`ddb3353`](https://github.com/cosmos1255/python-semantic-release/commit/ddb3353876601b5bb39563a8fbcced63e9769c8d))

* 3.11.0 ([`54e003c`](https://github.com/cosmos1255/python-semantic-release/commit/54e003c8e9c358427067326a2507a279474761b7))

* 3.10.3 ([`c15e0de`](https://github.com/cosmos1255/python-semantic-release/commit/c15e0debb4dcdc7f15aa1ff6e1f23a99c83579a6))

* 3.10.2 ([`0907db4`](https://github.com/cosmos1255/python-semantic-release/commit/0907db4044e20895d1b9c4f9fb1de33a5d79c06e))

* 3.10.1 ([`500972c`](https://github.com/cosmos1255/python-semantic-release/commit/500972c0f9c0393a02bdfd8afea628772a0611c1))

* revert: &#34;chore: Remove travis&#34;

This reverts commit 93e5507da6d53ecf63405507390633ef480c52fb. ([`195ed8d`](https://github.com/cosmos1255/python-semantic-release/commit/195ed8ddc004b736cd4e0301e5d7c7f6394cf4a5))

* 3.10.0 ([`7cfe01d`](https://github.com/cosmos1255/python-semantic-release/commit/7cfe01d9dd35b74892d64238c4aa0d50b845b113))

* 3.9.0 ([`52bf48b`](https://github.com/cosmos1255/python-semantic-release/commit/52bf48b93be7d8feeef5207f0dc9f7ddbd583da4))

* Merge pull request #54 from KenMercusLai/master

add option to use tag instead of creating new commit when versioning ([`8e9c021`](https://github.com/cosmos1255/python-semantic-release/commit/8e9c021cdf6bf8ed3d7cc7dc9c42187e893f23bf))

* 3.8.1 ([`378e2eb`](https://github.com/cosmos1255/python-semantic-release/commit/378e2eb6d228cc8b6e5c57e78cae3fe801fc974b))

* 3.8.0 ([`8779773`](https://github.com/cosmos1255/python-semantic-release/commit/8779773444f54a8090b9d341b644f68a70ddb785))

* Merge pull request #57 from relekang/feat/add-circle-ci-checks

Add circle ci checks ([`7af9816`](https://github.com/cosmos1255/python-semantic-release/commit/7af9816610669a9c697bfe198e98da33e5ed0a29))

* Merge pull request #58 from relekang/refactor-cli-py

fix: Refactoring cli.py to improve --help and error messages ([`a0bf0ff`](https://github.com/cosmos1255/python-semantic-release/commit/a0bf0ff0eb0cd0140f851b9f7b7e18c2710dbad5))

* Merge pull request #60 from relekang/test/fix-cli-tests

test: Mock to fix cli tests ([`d6df71d`](https://github.com/cosmos1255/python-semantic-release/commit/d6df71d6fb990c84bf5e01d45d5b0cab399da4d8))

* Merge pull request #59 from relekang/test/fix-structure

fix: Make tag parser work correctly with breaking changes ([`1e9a581`](https://github.com/cosmos1255/python-semantic-release/commit/1e9a581e89757fb603a340bbc519e07b59b143e9))

* Merge pull request #56 from relekang/dev-deps

chore: Add tox and sphinx as dev dependencies ([`3beb444`](https://github.com/cosmos1255/python-semantic-release/commit/3beb444ba34da785a2c3bcf2359e561c9be7abdd))

* 3.7.2 ([`dde8bbf`](https://github.com/cosmos1255/python-semantic-release/commit/dde8bbfd71d048d05a92d87bae0c6e45056b52e2))

* Merge pull request #55 from relekang/flake8-fixes

fix: move code around a bit to make flake8 happy ([`2184549`](https://github.com/cosmos1255/python-semantic-release/commit/218454986be540b90e7d3af45a76c02d3c5f6ee2))

* 3.7.1 ([`0aaa112`](https://github.com/cosmos1255/python-semantic-release/commit/0aaa112880559e968f8c0053cfb84cf7eaed64cf))

* Merge pull request #50 from edwelker/doc_fix

documentation typo ([`b3c52c2`](https://github.com/cosmos1255/python-semantic-release/commit/b3c52c27293f8944ea34a6a42b348082e80275fe))

* documentation typo ([`b77d484`](https://github.com/cosmos1255/python-semantic-release/commit/b77d484e119daa0c2fe86bc558eda972d4852a83))

* 3.7.0 ([`10825b5`](https://github.com/cosmos1255/python-semantic-release/commit/10825b5fe633f7cc2ea618ac3402be36fc10e8ee))

* 3.6.1 ([`8f5dd02`](https://github.com/cosmos1255/python-semantic-release/commit/8f5dd025577c8d66c2d762070bfebbe31c77ab00))

* 3.6.0 ([`4916f16`](https://github.com/cosmos1255/python-semantic-release/commit/4916f16c0a6602fafd52222f3c930ceebade686a))

* 3.5.0 ([`fb67b5f`](https://github.com/cosmos1255/python-semantic-release/commit/fb67b5ffb2df7d11b1daf6d7eef46f843f5cfd62))

* 3.4.0 ([`397ba66`](https://github.com/cosmos1255/python-semantic-release/commit/397ba668f4bbb1f6a0385390ce1f4e4efbf98dbf))

* 3.3.3 ([`d1664bb`](https://github.com/cosmos1255/python-semantic-release/commit/d1664bbaa83ea60c15c5652f7dfe2084e458d48d))

* 3.3.2 ([`68510b6`](https://github.com/cosmos1255/python-semantic-release/commit/68510b6f27923d407087db07c56deb2f2f404fe4))

* 3.3.1 ([`0334b81`](https://github.com/cosmos1255/python-semantic-release/commit/0334b81c247be5bf222975d894f5ced9d38fb812))

* Merge remote-tracking branch &#39;origin/depsy/click-equals-6.2&#39; ([`f0f7937`](https://github.com/cosmos1255/python-semantic-release/commit/f0f7937cca61c53b25e1e39b78356345e73b2033))

* Upgrade dependency click to ==6.2 ([`1c5f3cd`](https://github.com/cosmos1255/python-semantic-release/commit/1c5f3cde6a8a892b1fe48eae39424d3d483b5935))

* 3.2.1 ([`ab83167`](https://github.com/cosmos1255/python-semantic-release/commit/ab83167d630bde385622178147037856641e2118))

* 3.2.0 ([`bf85122`](https://github.com/cosmos1255/python-semantic-release/commit/bf85122335173076fa6c018a506a546fa16b0aa6))

* Merge pull request #29 from relekang/depsy-decisive-upgrade-15_10_17_07_51_03

[Depsy] Upgrade dependencies ([`4987a31`](https://github.com/cosmos1255/python-semantic-release/commit/4987a31ae78e8fc202497a01591ba0881e82437e))

* Add links to the node project ([`3567952`](https://github.com/cosmos1255/python-semantic-release/commit/3567952d8e84235c58aa7e310689de8d4b07f7ad))

* Upgrade dependency twine to ==1.6.3 ([`f96e9b2`](https://github.com/cosmos1255/python-semantic-release/commit/f96e9b2e066465e657b3d25708713f5d20b6942f))

* Upgrade dependency semver to ==2.2.1 ([`63b4b99`](https://github.com/cosmos1255/python-semantic-release/commit/63b4b9949816cef110a2ce3c10707525623bd8ef))

* Upgrade dependency invoke to ==0.11.1 ([`b9fe5eb`](https://github.com/cosmos1255/python-semantic-release/commit/b9fe5eb8bf1f44df53ffe7924c999142d65b5520))

* Upgrade dependency click to ==5.1 ([`662bc2d`](https://github.com/cosmos1255/python-semantic-release/commit/662bc2dea8f4f9792bd63d8a6490181547aa1499))

* Upgrade dependency twine to ==1.6.3 ([`571dd43`](https://github.com/cosmos1255/python-semantic-release/commit/571dd43f10498882b2828afb334c9e82f839e040))

* Upgrade dependency semver to ==2.2.1 ([`e656bea`](https://github.com/cosmos1255/python-semantic-release/commit/e656bea8c0004e6952f8868569a7460a13ae3e40))

* Upgrade dependency invoke to ==0.11.1 ([`31a2051`](https://github.com/cosmos1255/python-semantic-release/commit/31a205143492a13bc796cf9755ae78231ae35c00))

* Upgrade dependency click to ==5.1 ([`d0b6c7d`](https://github.com/cosmos1255/python-semantic-release/commit/d0b6c7d968961d7bc84560ca22f3b9a8634e08a9))

* Upgrade dependency responses to ==0.5.0 ([`fcf9e1a`](https://github.com/cosmos1255/python-semantic-release/commit/fcf9e1a806236fc09a472ba6e58cf44f57b2147f))

* 3.1.0 ([`93cb147`](https://github.com/cosmos1255/python-semantic-release/commit/93cb147ca0d360cd5c51b642f8d7ce2abb576698))

* 3.0.0 ([`592fedb`](https://github.com/cosmos1255/python-semantic-release/commit/592fedb52633de40e0b07b418acc6c9d796179a4))

* Merge branch &#39;tag-parser&#39; ([`2519b42`](https://github.com/cosmos1255/python-semantic-release/commit/2519b42c7381fe8217b34150bd1ad06b23c9a56d))

* 2.1.4 ([`a05210f`](https://github.com/cosmos1255/python-semantic-release/commit/a05210f4274f10ddd5385241c99b6d77996c9544))

* 2.1.3 ([`4979071`](https://github.com/cosmos1255/python-semantic-release/commit/4979071d9330f2f3648358000de3a642a385a828))

* 2.1.2 ([`dfb37cb`](https://github.com/cosmos1255/python-semantic-release/commit/dfb37cbde0a877ca482095711cbb08f52ab3cf45))

* 2.1.1 ([`7cf3a7d`](https://github.com/cosmos1255/python-semantic-release/commit/7cf3a7d9aa2adc5a3cebf9d1151b113388117312))

* 2.1.0 ([`4b78940`](https://github.com/cosmos1255/python-semantic-release/commit/4b789409936a5997d6c2f277083930b6e4b3b643))

* 2.0.0 ([`6493a58`](https://github.com/cosmos1255/python-semantic-release/commit/6493a58727ecd082e3ae12619fef6c3c982cc6e2))

* Add badges in readme ([`ad7c9c6`](https://github.com/cosmos1255/python-semantic-release/commit/ad7c9c69329efe8af42112f716c39e810ed22718))

* Add cumulative coverage ([`15c5ea0`](https://github.com/cosmos1255/python-semantic-release/commit/15c5ea0106ed08ef8d896d100cf1987c0b5fc17a))

* Update api-docs ([`4654655`](https://github.com/cosmos1255/python-semantic-release/commit/4654655c33afc7cead9c238a14e4b71cc7121aa5))

* Fix #19, add config documentation ([`354b2ca`](https://github.com/cosmos1255/python-semantic-release/commit/354b2cabfc7e4a8d2c95ebd2801cc4dbca67fa5a))

* 1.0.0 ([`a91662c`](https://github.com/cosmos1255/python-semantic-release/commit/a91662c55d01af096cc45bf8844bcc6d87c1bcee))

* :boom: Restructure helpers into history and pypi ([`00f64e6`](https://github.com/cosmos1255/python-semantic-release/commit/00f64e623db0e21470d55488c5081e12d6c11fd3))

* Rename git_helpers to vcs_helpers ([`77d701b`](https://github.com/cosmos1255/python-semantic-release/commit/77d701b89c93a761c83965f7c267c7ec35989ec2))

* Make authors file a list ([`31b0f3a`](https://github.com/cosmos1255/python-semantic-release/commit/31b0f3a3c6a0c5e9d4d9521aba0a303adefdeeec))

* Fix #18, add docs for automatic publishing ([`58076e6`](https://github.com/cosmos1255/python-semantic-release/commit/58076e60bf20a5835b112b5e99a86c7425ffe7d9))

* Set alabaster as sphinx theme ([`1f698fe`](https://github.com/cosmos1255/python-semantic-release/commit/1f698fe249a3cc646006b6f922e6b7ec8e12563f))

* Add @jezdez to AUTHORS.rst ([`985df2d`](https://github.com/cosmos1255/python-semantic-release/commit/985df2dd052668f72e99274370e335e47d5c5d39))

* Add pytest-xdist as requirements ([`35961d7`](https://github.com/cosmos1255/python-semantic-release/commit/35961d7cc17a862710661b9f9e25aa276d2f505b))

* Fix current head hash test ([`ed9a879`](https://github.com/cosmos1255/python-semantic-release/commit/ed9a8795d2e72cbdd6689eec4fea2622a5654bc6))

* 0.9.1 ([`240971f`](https://github.com/cosmos1255/python-semantic-release/commit/240971f4de808be27a5d8c54bd40156d80d38913))

* :bug: Fix get_current_head_hash, ensure it only returns the hash ([`7c28832`](https://github.com/cosmos1255/python-semantic-release/commit/7c2883209e5bf4a568de60dbdbfc3741d34f38b4))

* 0.9.0 ([`85bfaae`](https://github.com/cosmos1255/python-semantic-release/commit/85bfaaec2236e6c144bfb31ea12240ed6150c28b))

* Merge pull request #15 from jezdez/python-2

Add Python 2.7 support. Fix #10.
:sparkles: ([`5daabb7`](https://github.com/cosmos1255/python-semantic-release/commit/5daabb75eb9145566a2a7c2a9e64439df7cd85f1))

* Add Python 2.7 support. Fix #10. ([`c05e13f`](https://github.com/cosmos1255/python-semantic-release/commit/c05e13f22163237e963c493ffeda7e140f0202c6))

* Merge pull request #14 from jezdez/assertion-fix

Fixed name of assertion function. ([`aeb62df`](https://github.com/cosmos1255/python-semantic-release/commit/aeb62dfcb6aa123f47f612dc209415c7fb4fe889))

* Fixed cli tests to use correct params for call assertion. ([`456b26b`](https://github.com/cosmos1255/python-semantic-release/commit/456b26be7130e51a7a46310f65dffb615b30a097))

* Fixed name of assertion function. ([`9b16098`](https://github.com/cosmos1255/python-semantic-release/commit/9b1609813ae71d5605b8ec9754d737ba38465537))

* 0.8.0 ([`6ec8a3e`](https://github.com/cosmos1255/python-semantic-release/commit/6ec8a3e22f0914dd0d995c809f5b5d078825bc9a))

* Fix version test, add missing mock ([`71842d4`](https://github.com/cosmos1255/python-semantic-release/commit/71842d4d50fa16fbdba0487d1c8f6d0eb6b7d407))

* Set check_build_status in semantic-release config ([`00f1a4e`](https://github.com/cosmos1255/python-semantic-release/commit/00f1a4ef5283733d580c6bb02ed25d511a8b0c0b))

* :bug: Fix test_defaults in settings test ([`b269d27`](https://github.com/cosmos1255/python-semantic-release/commit/b269d27ca1c1cfc9efd25abab2de619b6f3ef9d6))

* Add release schedule note ([`8bc8fba`](https://github.com/cosmos1255/python-semantic-release/commit/8bc8fba7dc3bd6bcea0cc5e5946e85f6f8e1c6d7))

* Add output when running check_build_status ([`8bdda5a`](https://github.com/cosmos1255/python-semantic-release/commit/8bdda5aba626fcbed8d357551f6d77fca5d1839d))

* Add default value in check_build_status docs ([`eb0c46d`](https://github.com/cosmos1255/python-semantic-release/commit/eb0c46d00e0f07e1e902b33470dbf7309146964f))

* :sparkles: Fix #5, Add check_build_status option ([`310bb93`](https://github.com/cosmos1255/python-semantic-release/commit/310bb9371673fcf9b7b7be48422b89ab99753f04))

* :sparkles: Add get_current_head_hash in git helpers ([`d864282`](https://github.com/cosmos1255/python-semantic-release/commit/d864282c498f0025224407b3eeac69522c2a7ca0))

* :sparkles: Add git helper to get owner and name of repo ([`f940b43`](https://github.com/cosmos1255/python-semantic-release/commit/f940b435537a3c93ab06170d4a57287546bd8d3b))

* 0.7.0 ([`aeb11f7`](https://github.com/cosmos1255/python-semantic-release/commit/aeb11f74a93fe7e64e9507f9a62202b833ee5733))

* :sparkles: Add patch_without_tag option, fixes #6 ([`3734a88`](https://github.com/cosmos1255/python-semantic-release/commit/3734a889f753f1b9023876e100031be6475a90d1))

* Move defaults to cfg file ([`cb1257a`](https://github.com/cosmos1255/python-semantic-release/commit/cb1257a60a81cb5aadbc8f6470ec2ec2c904506c))

* Add contributing.rst ([`a27e282`](https://github.com/cosmos1255/python-semantic-release/commit/a27e28223b8186bda66cc882454746a5595d8643))

* Fix docstring in setup_hook() ([`1e47f1c`](https://github.com/cosmos1255/python-semantic-release/commit/1e47f1c6c68b5a74515f2f86275e3c749c999e1c))

* Fix #1, Add basic setup of sphinx based docs ([`41fba78`](https://github.com/cosmos1255/python-semantic-release/commit/41fba78a389a8d841316946757a23a7570763c39))

* Add docstrings to all functions ([`6555d5a`](https://github.com/cosmos1255/python-semantic-release/commit/6555d5a5944fa4b7823f70fd720e193915186307))

* 0.6.0 ([`3acd8db`](https://github.com/cosmos1255/python-semantic-release/commit/3acd8dbdd25f3973a536924985a37726d8665cdd))

* :sparkles: Fix #13, Add twine for uploads to pypi ([`eec2561`](https://github.com/cosmos1255/python-semantic-release/commit/eec256115b28b0a18136a26d74cfc3232502f1a6))

* Add tests for the setup.py hook ([`ecd9e9a`](https://github.com/cosmos1255/python-semantic-release/commit/ecd9e9a3f97bdf9489b6dc750d736855a2c109c2))

* Add test for git helpers ([`8354cfd`](https://github.com/cosmos1255/python-semantic-release/commit/8354cfd953bb09723abcff7fefe620fc4aa6b855))

* Fix typo ([`9585217`](https://github.com/cosmos1255/python-semantic-release/commit/9585217d95a4bb2447ae8860971575bd4c847070))

* Add link to blogpost in readme ([`1966e52`](https://github.com/cosmos1255/python-semantic-release/commit/1966e52ab4f08d3cbabe88881c0e51e600e44567))

* 0.5.4 ([`b66939b`](https://github.com/cosmos1255/python-semantic-release/commit/b66939bff790c21bd1093e9b8ae6a5dff5f38235))

* Add tests for upload_to_pypi ([`778923f`](https://github.com/cosmos1255/python-semantic-release/commit/778923fab86d423b6ed254c569fddee1b9650f56))

* :bug: Add python2 not supported warning

Related: #9, #10 ([`e84c4d8`](https://github.com/cosmos1255/python-semantic-release/commit/e84c4d8b6f212aec174baccd188185627b5039b6))

* Add note about python 3 only

related to #9 ([`a71b536`](https://github.com/cosmos1255/python-semantic-release/commit/a71b53609db75316e3c14df0ece7f474393641bc))

* 0.5.3 ([`bed6e58`](https://github.com/cosmos1255/python-semantic-release/commit/bed6e583161fd7651c69660ef9c6ab3252907cb9))

* Add wheel as a dependency ([`971e479`](https://github.com/cosmos1255/python-semantic-release/commit/971e4795a8b8fea371fcc02dc9221f58a0559f32))

* 0.5.2 ([`f66a1f9`](https://github.com/cosmos1255/python-semantic-release/commit/f66a1f92072d9927c35ac4ac54153bd9b5a8b3a0))

* :bug: Fix python wheel tag ([`f9ac163`](https://github.com/cosmos1255/python-semantic-release/commit/f9ac163491666022c809ad49846f3c61966e10c1))

* 0.5.1 ([`6a2311a`](https://github.com/cosmos1255/python-semantic-release/commit/6a2311adb7c4745908c0fa0ea4e5759b0e46d2b6))

* :bug: Fix push commands ([`8374ef6`](https://github.com/cosmos1255/python-semantic-release/commit/8374ef6bd78eb564a6d846b882c99a67e116394e))

* 0.5.0 ([`e888160`](https://github.com/cosmos1255/python-semantic-release/commit/e8881604c94808d0e86387cc18ee81885870e1e7))

* :sparkles: Add setup.py hook for the cli interface ([`c363bc5`](https://github.com/cosmos1255/python-semantic-release/commit/c363bc5d3cb9e9a113de3cd0c49dd54a5ea9cf35))

* 0.4.0 ([`bfb1434`](https://github.com/cosmos1255/python-semantic-release/commit/bfb1434f1861fe99dd28b653467034db1e271dfb))

* :sparkles: Add publish command ([`d8116c9`](https://github.com/cosmos1255/python-semantic-release/commit/d8116c9dec472d0007973939363388d598697784))

* 0.3.2 ([`1d3ee00`](https://github.com/cosmos1255/python-semantic-release/commit/1d3ee00c3601f06f900bc1694f3c7c32106a6e14))

* 0.3.1 ([`fec284c`](https://github.com/cosmos1255/python-semantic-release/commit/fec284cdec7516b7b8067d5de2738e62434d3f31))

* :bug: Fix wheel settings ([`1e860e8`](https://github.com/cosmos1255/python-semantic-release/commit/1e860e8a4d9ec580449a0b87be9660a9482fa2a4))

* 0.3.0 ([`d633a28`](https://github.com/cosmos1255/python-semantic-release/commit/d633a2811f2e14581793ebdf08b852dc6024dd44))

* Add info about tagging in readme ([`914c78f`](https://github.com/cosmos1255/python-semantic-release/commit/914c78f0e1e15043c080e6d1ee56eccb5a70dd7d))

* :sparkles: Add support for tagging releases ([`5f4736f`](https://github.com/cosmos1255/python-semantic-release/commit/5f4736f4e41bc96d36caa76ca58be0e1e7931069))

* :bug: Fix issue with committing the same version # ([`441798a`](https://github.com/cosmos1255/python-semantic-release/commit/441798a223195138c0d3d2c51fc916137fef9a6c))

* Remove patch as default for untagged history ([`e44e2a1`](https://github.com/cosmos1255/python-semantic-release/commit/e44e2a166033b75f75351825f7e4e0866bb7c45b))

* Restructure and add tests ([`4546e1e`](https://github.com/cosmos1255/python-semantic-release/commit/4546e1e11429026c1a5410e17f8c5f866cfe5833))

* 0.2.0 ([`c3bad90`](https://github.com/cosmos1255/python-semantic-release/commit/c3bad90b53cc3312795da18881e6405d9cb8cdfc))

* Remove apt dependencies from frigg settings ([`d942a32`](https://github.com/cosmos1255/python-semantic-release/commit/d942a32bd475b3541c207069bd43d88f60a310a0))

* Fix get_commit_log ([`9af798a`](https://github.com/cosmos1255/python-semantic-release/commit/9af798abab0d0b69c36134f0189745e9703dbfba))

* Remove pygit2 and add gitpython ([`8165a2e`](https://github.com/cosmos1255/python-semantic-release/commit/8165a2eef2c6eea88bfa52e6db37abc7374cccba))

* Add test to check which parts of the git log is considered ([`bb384b1`](https://github.com/cosmos1255/python-semantic-release/commit/bb384b16d649ed2bb0f30cd3356c0e78f6e06e11))

* :sparkles: Add noop mode

Fixes #4 ([`44c2039`](https://github.com/cosmos1255/python-semantic-release/commit/44c203989aabc9366ba42ed2bc40eaccd7ac891c))

* Add docstrings in cli ([`315f6d2`](https://github.com/cosmos1255/python-semantic-release/commit/315f6d2e3c80c309e80733234ab123d07c10779d))

* Add installation of python3-cffi to frigg settings ([`aa38ca8`](https://github.com/cosmos1255/python-semantic-release/commit/aa38ca8c5c64a583ecc4fb78c4789a18a031ceae))

* Add installation of libgit2-dev in frigg settings ([`ff1d72b`](https://github.com/cosmos1255/python-semantic-release/commit/ff1d72b8f4a8e55317d3f3b0efebaeaf67fb8f63))

* Remove the this is not usable yet warning from readme ([`b14b468`](https://github.com/cosmos1255/python-semantic-release/commit/b14b468f96211fd754f7441b8c8ca371e9cd5ce1))

* Update usage docs in readme ([`1f753e6`](https://github.com/cosmos1255/python-semantic-release/commit/1f753e631b9b7e9d4234779ddaac31532ed77b88))

* Remove note about :arrow_up: in readme ([`1554051`](https://github.com/cosmos1255/python-semantic-release/commit/1554051d9e061094bc191812348c32c22d3d5f40))

* Update config docs in readme ([`06a261f`](https://github.com/cosmos1255/python-semantic-release/commit/06a261f14426c43713bb9ec32a87066ce2adb010))

* 0.1.1 ([`54a98fe`](https://github.com/cosmos1255/python-semantic-release/commit/54a98fedbf5f8a3898d0d9c27bca20e9b8a382e5))

* Fix libgit install in frigg settings ([`bd991c3`](https://github.com/cosmos1255/python-semantic-release/commit/bd991c3b3e1f69f86b1f6ca538e57b3ba365e376))

* :bug: Fix entry point ([`bd7ce7f`](https://github.com/cosmos1255/python-semantic-release/commit/bd7ce7f47c49e2027767fb770024a0d4033299fa))

* Fix badges ([`1e5df79`](https://github.com/cosmos1255/python-semantic-release/commit/1e5df79aa104768078e6e66d559ab88b751cc0a3))

* Add libgit2 to frigg settings ([`d55f25c`](https://github.com/cosmos1255/python-semantic-release/commit/d55f25cac13625037c5154e3cdd7dbb9bb88e350))

* Update readme ([`e8a6dd9`](https://github.com/cosmos1255/python-semantic-release/commit/e8a6dd9e264a3e2d4186c323f7b544d4e42754b1))

* 0.1.0 ([`30d5f43`](https://github.com/cosmos1255/python-semantic-release/commit/30d5f4376dc540548f68da921bd87ae7b21e7996))

* Add commiting of new version ([`6865d4b`](https://github.com/cosmos1255/python-semantic-release/commit/6865d4b9d39027effe1902b9c50479c832650f68))

* Add detection of change level ([`06c5ac4`](https://github.com/cosmos1255/python-semantic-release/commit/06c5ac4ce945223452c1331371c74130a2fc4b49))

* Fix coverage settings ([`4b80fab`](https://github.com/cosmos1255/python-semantic-release/commit/4b80fab7433a215c09a68b041fef9db2286f8428))

* :sparkles: Implement setting of new version ([`a2ad75b`](https://github.com/cosmos1255/python-semantic-release/commit/a2ad75b8dac515d1bbc49c32257c62a7da59e2e1))

* :sparkles: Add loading of config ([`51c5e93`](https://github.com/cosmos1255/python-semantic-release/commit/51c5e93adf2c4d4193d94cce2b661da7fb75138e))

* Fix readme badges ([`a3cc59b`](https://github.com/cosmos1255/python-semantic-release/commit/a3cc59b3471294ed0875624889dfde8cf8c6402f))

* Update readme ([`2b64782`](https://github.com/cosmos1255/python-semantic-release/commit/2b64782e3fd78aec1e9f8d8cd391efc8eb3a4416))

* Fix isort ([`11feb93`](https://github.com/cosmos1255/python-semantic-release/commit/11feb93c23c2bb51480191c5035fa92a7316e546))

* :sparkles: Add better force options ([`c6b4fe9`](https://github.com/cosmos1255/python-semantic-release/commit/c6b4fe999531516ff5657541e894c3156deffbcb))

* Remove print usage ([`5ca8957`](https://github.com/cosmos1255/python-semantic-release/commit/5ca8957b3974fdfa46fb66199f5848aa2711a49e))

* :sparkles: Implement get_new_version with semver ([`4bb1f10`](https://github.com/cosmos1255/python-semantic-release/commit/4bb1f10fba27256a4982ad2ff4e2478ace7893a7))

* :sparkles: Implement get_current_version ([`49de531`](https://github.com/cosmos1255/python-semantic-release/commit/49de531900b8d3cde4ae36d1f58f26da196e8177))

* :sparkles: Add basic cli interface ([`ff03d6e`](https://github.com/cosmos1255/python-semantic-release/commit/ff03d6e796ffee498e21c1457fd1c356418cc5e6))

* :sparkles: Add project structure ([`57f4c2b`](https://github.com/cosmos1255/python-semantic-release/commit/57f4c2bdbfe88f6318c87bf6b2fbf851bc9f5a90))

* Add a plan to the readme ([`6f87d66`](https://github.com/cosmos1255/python-semantic-release/commit/6f87d6691f95c6dd652ba5fdadf155e9a194bfb6))

* Initial commit ([`94abb4e`](https://github.com/cosmos1255/python-semantic-release/commit/94abb4e631d363f1f7ffcf85f026fc57845d4c1c))
